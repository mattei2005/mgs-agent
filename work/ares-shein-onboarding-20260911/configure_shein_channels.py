...
- Criacao/clone/lote Meta usa `direct-traffic-cbo-operations` e `meta-campaign-engine-v3`. Nao herdar objetivo, bid, estrutura, copy, budget, schedule ou template de outra operacao/gestor; resolver pelo pedido e estado Meta real.
