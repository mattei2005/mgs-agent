Title: Batch Requests - Graph API - Documentation - Meta for Developers

URL Source: http://developers.facebook.com/docs/graph-api/making-multiple-requests/
