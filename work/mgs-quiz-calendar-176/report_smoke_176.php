...
$calendar_checks = array(
    ...
    'form_lookup' => "var form=document.getElementById('mgsqReportFilters')",
    'apply_submits_filters' => "form.requestSubmit();",
    'submit_fallback' => "form.submit();",
    'filter_button_preserved' => 'Filtrar relatório</button>',
