...
continuity=[]
for sr,er,c1,c2 in [(5,35,4,ci('APE')),(46,76,4,ci('AMA')),(105,135,ci('RR'),ci('AGI')),(146,176,ci('RR'),ci('AGI'))]+[(r,r+30,ci('ZQ'),ci('ZX')) for r in [145,185,225,265,305]]+[(r,r+30,ci('AJM'),ci('AJT')) for r in [105,145,185,225,265,305]]:
