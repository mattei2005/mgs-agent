...
- `references/p1-gb-cc-en-structure-and-test-2026-05-19.md` — agreed P1 GB-CC-EN structure, image relationship rules, LazyBlock CTA differences from REC, Yoast handling, and the first HSBC Premier draft validation.
