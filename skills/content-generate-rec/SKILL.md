...
- `references/p1-gb-cc-en-structure-and-test-2026-05-19.md` — agreed P1 GB-CC-EN structure, image relationship rules, LazyBlock CTA differences from REC, Yoast handling, first HSBC Premier draft validation, and the deterministic `/root/mgs-agent/scripts/mgs-p1-runner.py` contract for routine P1 creation from an existing REC.
