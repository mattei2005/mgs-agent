...
- `references/dtr-sb-step1-step2-approved-concept-2026-07-06.md` — Rodolfo-approved final Step 1/Step 2 concept: no-campaign-data is neutral, Step 1 is inventory/scope only, unsafe context requires repeated non-empty campaign signatures, and reports should translate raw labels into simple operational buckets.
