...
4. For portfolio work, iterate every segurador under each authorized login. Within each segurador, process every page represented in the scheduled list.
5. For a pilot scoped to the “first page”, use the page name in the first eligible campaign row, then filter/search that page and enumerate all eligible campaigns.
