...
Future agent work: if the same formatting drift appears in Atena/Ares/Hera outputs, apply the same class-level rule to those agents' SOULs as well, with backup + live/versioned sync.
