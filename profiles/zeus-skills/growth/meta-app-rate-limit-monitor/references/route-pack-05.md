...
For all five apps, fresh isolated preflight proved app metadata, paginated `/roles`, `/me` and `debug_token` HTTP 200; every token is valid and app-bound; every returned role identity resolved with zero unresolved IDs. First production baselines started at 2/13, 2/14, 1/15, 2/9 and 3/13. By the closure snapshot at `2026-09-02T10:44:08-04:00`, normal role acceptances had advanced the live counts to 7/13, 2/14, 1/15, 2/9 and 10/13. These counts are live onboarding state and must not be frozen because role acceptances can occur during the cutover itself.

The canonical Service Account Sheet already used the new generation labels and had zero predecessor rows. Closure parity at that snapshot was: B003-3 7 present/6 X, B005-4 2 present/12 X, B006-4 1 present/14 X, B008-3 2 present/7 X, and B010-3 10 present/3 X. Present identities are blank and every absent assigned identity is X. During B006-4 onboarding, `Bruna Andrade` disappeared from the live Sheet between preflight and production, reducing the active assignment set from 16 to 15; audit, inventory and REPORT-INFRA had no attribution evidence, so the runtime reconciled to the authoritative 15-row readback and records the change as concurrent/unattributed rather than an anomaly.

Production state was reset per generation: B003-2, B005-3, B006-3, B008-2 and B010-2 were retired to backup/retired metadata and their app-scoped role IDs, cooldowns and restriction errors were not reused. Each first production baseline was silent and each immediate second scoped cycle completed with zero errors and no duplicate alert/Sheet write. The later full-registry cycle completed with all 12 items and zero errors; real subsequent role acceptances generated the normal B003-3/B010-3 addition alerts. At the closure snapshot B010-3 reached `call_count=97%` (`critical`) and the monitor delivered the normal rate-limit notice; stop manual validation calls and let the rolling Meta quota window recover while the recurring monitor remains the authoritative signal. This is an active quota risk, not a credential/cutover failure. The shared cron `0cc7ed1e587e` remains enabled/scheduled, and the manual app-alert pause is now empty.
...
### Current B001-4 and B002-3 cutovers — 2026-08-28
...
Channels       B001-4 1521251196294135858 (live channel name still b001-2-app-status); B002-3 1521251220130496723 (live channel name still b002-2-app-status); B003-3 1521251246860931223; B004-4 1521251334496456815 (live channel name still b004-3-app-status); B005-4 1521251961662341160; B006-4 1521252068319297666; B007-2 1520510823426949313; B008-3 1521252172929564744; B009-3 1521252284623884288 (live channel name still b009-2-app-status); B010-3 1521252369331916902; B011-2 1537256907373289575; B012-2 1537256951879172136
```
...
For “todos os 11 canais”, validate the registry-driven current set: `B001-4`, `B002-3`, `B003-3`, `B004-4`, `B005-4`, `B006-4`, `B007-2`, `B008-3`, `B009-3`, `B010-3`, and `B013-4`. B013-4 routes to the dedicated DTR/ChatPion monitor at channel ID `1522830283240505385`; there must be no stale alternate runtime state, script, Sheet label, or alert title.
...
X-App-Usage >=85%                    risk alert; for B007-2/Openzed act fast
...
- For Rodolfo requests like “manda alerta real em todos os 11 canais”, scope is registry-driven: the current B001–B010 replacement lineage plus B013-4. As of 2026-09-02 this is exactly `B001-4`, `B002-3`, `B003-3`, `B004-4`, `B005-4`, `B006-4`, `B007-2`, `B008-3`, `B009-3`, `B010-3`, and `B013-4`. B013-4 must route through the dedicated DTR monitor, never the Meta `/roles` monitor.
- Current Sheet assignment parsing must preserve alpha and hyphen suffixes such as `B001-4`, `B002-3`, `B003-3`, `B004-4`, `B005-4`, `B006-4`, `B007-2`, `B008-3`, `B009-3`, `B010-3`, and `B013-4`. The live assignment header is `NO APP` after the 2026-08-13 rebuild; do not normalize replacement labels to predecessor app keys, and do not fall back to blank `APP PROVISORIO` rows.
...
```text
B001-4  #b001-2-app-status  1521251196294135858
...
B007-2  #b007-app-rate-limit  1520510823426949313
...
Meta App Rate Limit — B007-2/Openzed
...
```
