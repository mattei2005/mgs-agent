...
- Quando a cadência de relatório mudar, não deslocar silenciosamente o checkpoint de ação. Separar `report schedule` de `action-only checkpoint`, registrar a agenda vigente na fonte canônica da operação e superseder explicitamente a agenda anterior. Em Creditoparaveiculo BR-CAR-BR, a agenda vigente é: Diário 07:00 do dia anterior fechado; Intraday 11:00, 14:00 e 20:00 do dia corrente; escala autorizada às 08:00 em checkpoint separado, sem relatório extra. Snapshot de continuidade às 03:00 é diário, local, preserva dados Meta × Smart Bidding do dia anterior e nunca reseta sessão; compactação de contexto permanece nativa do Hermes.
