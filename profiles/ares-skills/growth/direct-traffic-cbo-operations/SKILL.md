...
- O Intraday mantém histórico canônico de ROI SB das últimas três datas somente na tabela histórica compacta para desktop: dia atual parcial mais os dois dias-calendário anteriores. A fonte é Smart Bidding `NET_REVENUE` em USD com revenue share ativo; data sem investimento/match aparece como `n/d`; o dia atual recebe `*` e nota explícita de parcialidade até o horário do envio. Não misturar esses ROIs diários com ROI acumulado.
