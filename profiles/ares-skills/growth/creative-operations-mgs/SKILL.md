...
- **Migração para Shared Drive, preflight de entitlement, piloto e escolha do Google Workspace** → `references/shared-drive-migration-and-workspace-plans.md`; evidência Enterprise Essentials validada → `references/shared-drive-enterprise-essentials-pilot-2026-07-15.md`
