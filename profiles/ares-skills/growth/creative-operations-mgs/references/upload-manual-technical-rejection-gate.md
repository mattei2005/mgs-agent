...
- Em `My Drive`, a propriedade é por arquivo: uma pasta pode pertencer ao Rodolfo enquanto um arquivo enviado por colaborador dentro dela continua pertencendo ao uploader. Estar na pasta do Rodolfo não concede automaticamente `canTrash` sobre o arquivo.
- Não substituir nem rotacionar o OAuth canônico do Ares para a conta de um colaborador somente para excluir um arquivo. Isso mudaria a identidade operacional de todo o Drive. Preferir: o proprietário envia o arquivo à lixeira, ou transfere a propriedade ao Rodolfo; reautenticar outra conta só com aprovação explícita para mudar a identidade da integração.
