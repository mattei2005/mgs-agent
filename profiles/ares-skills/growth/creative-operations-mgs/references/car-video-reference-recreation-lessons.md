...
Use this reference when a gestor asks Ares to create a **variation of an existing car-financing video** using a reference video, ad library, or prior creative.
...
──────────────────────
[What Ares understood from the reference and requested changes]
