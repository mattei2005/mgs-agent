...
- Para `code=2` transitório em child do Graph Batch, usar a capacidade efetiva restante da lane para escolher o retry: bundle de uma campanha pode retomar após a margem de 5s quando ainda cabe uma reserva completa de recovery; bundle de duas campanhas que já ocupou 60 aguarda o reset. Em ambos os casos, preservar children bem-sucedidos, fazer readback por slot/lineage e repetir somente o anúncio comprovadamente ausente.
