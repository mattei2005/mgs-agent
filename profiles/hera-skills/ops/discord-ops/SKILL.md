...
- **Criando/ativando novo agente Discord (Zeus/Atena/Ares) → Layout de alertas automáticos via webhook** → `references/route-pack-02.md`
- **SEÇÃO B — Roles Managed (não deletáveis via API) → Discord mostrando retry/TTFB técnico em toda mensagem** → `references/route-pack-03.md`
- **Live tool-call trace no Discord com cleanup automático → Regressão/quirk: `free_response_channels` pode desativar auto-thread** → `references/route-pack-04.md`
- **Diagnóstico → Logs úteis** → `references/route-pack-05.md`
...
- **SEÇÃO E — Versionamento e Edição de Profiles (SOUL.md, config.yaml, skills) → Adicionar novo agente ao sync** → `references/route-pack-07.md`
- **Política de extensão de skills** → `references/route-pack-08.md`
