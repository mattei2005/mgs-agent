...
- **SEÇÃO A — Comunicação Inter-Agente (Zeus → Atena)** → `references/router-01-se-o-a-comunica-o-inter-agente-zeus-atena.md`
- **SEÇÃO B — Roles Managed (não deletáveis via API)** → `references/router-02-se-o-b-roles-managed-n-o-delet-veis-via-api.md`
- **SEÇÃO C — Hook git post-commit com notificação Discord** → `references/router-03-se-o-c-hook-git-post-commit-com-notifica-o-discord.md`
- **SEÇÃO D — Diagnóstico, Cron Scheduler e Reinicialização de Agente (Gateway Hermes)** → `references/router-04-se-o-d-diagn-stico-cron-scheduler-e-reinicializa-o-de-agente-gat.md`
- **SEÇÃO F — Threads: Ciclo de Vida, Tokens e Leitura de Histórico** → `references/router-05-se-o-f-threads-ciclo-de-vida-tokens-e-leitura-de-hist-rico.md`
- **SEÇÃO G — Importar histórico de thread antiga por link/ID** → `references/router-06-se-o-g-importar-hist-rico-de-thread-antiga-por-link-id.md`
- **SEÇÃO E — Versionamento e Edição de Profiles (SOUL.md, config.yaml, skills)** → `references/router-07-se-o-e-versionamento-e-edi-o-de-profiles-soul-md-config-yaml-ski.md`
