...
Sessão de origem: alinhamento Hera/Ares/Kelly no teste do asset `CAR_US_EN_VID_NO_DOWN_PAYMENT_PV_001.mp4`.

## Aprendizado operacional

Quando Kelly/humano manda criativo com país, vertical e língua, a Hera deve detectar tipo/formato/ângulo/pessoa, limpar metadata, renomear e colocar no READY canônico da operação.
