# Spain CC human upload → Hera classification → Ares handoff

Use this reference when Kelly/Geizian/gestor uploads Spanish credit-card creatives and asks whether Hera or Ares should apply the agreed rules.

## Responsibility split

```text
Hera applies directly
─────────────────────
...
3. Ask for/reinitiate the established Google Drive OAuth refresh flow for the Ares/Hera Drive client.
