...
4. Regra de provider atualizada por Rodolfo:
   ...
   - Se o pedido for **imagem**, pode usar **GPT/OpenAI** ou **Grok/xAI**; o gestor pode definir o provider no pedido, ou a Hera pode propor comparação quando fizer sentido.
...
2. Procure primeiro os artefatos locais já gerados na pasta da thread, por exemplo:
   ```text
   /root/mgs-agent/data/hera/<thread_id>/generated/
   /root/mgs-agent/data/hera/<thread_id>/frames/
   /root/mgs-agent/data/hera/<thread_id>/contact_sheet.jpg
   ```
