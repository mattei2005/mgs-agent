...
Use esta referência quando a Hera receber pedidos de variação de criativo/vídeo ou precisar alternar GPT/OpenAI e Grok/xAI.
...
```bash
HERMES_HOME=/root/.hermes/profiles/hera hermes auth add xai-oauth --manual-paste
```
