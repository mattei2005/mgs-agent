...
- Primeiro uso da partição, `2026-09-13`: 2.411/2.412 linhas confirmadas → 53 grupos aplicados, USD `6236.244543429341095371` e CAD `21482.89965596361935351023`; uma linha `pl_digital-trust_mavroa_us`, CAD `0.001441427765333875`, permaneceu pendente. Revisão 192→193, audit 970, recovery parcial bloqueado, replay idempotente e API pública autenticada passaram; a revisão corrente 194 foi reconciliada como `AUTO_QUOTES_UPDATED`. O Relatório Diário exibe 13/09 como `parcial` em desktop e mobile, enquanto o cutoff/totais do Realizado permanecem em `2026-09-12`. A decisão histórica Mavroa `us-shein-es`/`g002-d` era explicitamente limitada à revisão 01–09/09 e não pode virar regra permanente sem nova confirmação.
