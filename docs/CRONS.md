...
Gerado em: `2026-07-05T03:24:36-04:00`
Fonte: `root crontab + script/log stat, read-only`
Total MGS ativo no root crontab: **27**
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-05T03:20:01-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-05T03:11:14-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=a42e4ca4
23 10 * * *         | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo | baixo                                                                | sim   | [2026-07-04T10:23:03-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-05 03:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-05T03:21:01-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                                | sim   | Zeus 742 Atena 0 Ares 0 Hera 0
3-58/5 * * * *      | monitor-tool-loops.sh                      | Zeus/Infra     | baixo                                                                | sim   | Loop detector: 0 alertas enviados
0 5 * * *           | infra-discovery.sh                         | Zeus/Infra     | médio: sobrescreve infra-inventory.json                              | sim   | [01:41:53] === infra-discovery.sh DONE ===
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                                | sim   | [2026-07-04T20:37:03-04:00] OK notified upstream=7e8f50a14 local=7203898ce behind=34 days=0 feat=4 fix=20 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-05T03:15:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-05T03:00:01-0400] DONE total closed zombie sessions: 1 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família         | sim   | [2026-07-05T03:17:04-04:00] housekeeping: === END — deletados 7 arquivos / 3162.41 MB ===
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-05T07:15:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py                      | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=25 generated_at=2026-07-04T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-05T07:15:01Z] cron-stale check: jobs=26 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-05T07:20:01.672721Z done posted=0 skipped=0 candidates=0 last_seen_id=1523126361915523215
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-04T20:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *          | mgs-safety-backup.sh                       | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão                 | sim   | [2026-07-02T03:43:22-04:00] mgs-safety-backup: END OK archive=/root/mgs-agent/backups/safety/mgs-safety-20260702-034101.tar.gz size=3387.70MB manifest=/root/mgs-agent/backups/safety/mgs-safety-20260702-034101.manifest.tx
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-05T03:15:43-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra     | não classificado                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares", "hera"], "checked": 10, "stale": 0, "archived": 0, "skipped_recent": 10, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-05T03:20:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
0 8,16 * * *        | monitor-sb-restricted-pages.sh             | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-04T16:00:13-04:00] monitor-sb-restricted-pages: OK
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-05T07:22:01Z] alerts-infra-failed-alert-resolver: DONE candidates=1 handled=0 skipped=1 last_seen_id=1523226190750548020
```
...
- **Último log:** 2026-07-05T03:20:01-04:00 (1806925 bytes)
...
- **Último log:** 2026-07-05T03:11:14-04:00 (583446 bytes)
...
- **Último log:** 2026-07-04T10:23:03-04:00 (8859 bytes)
...
- **Último log:** 2026-07-05T03:22:02-04:00 (206724 bytes)
...
- **Último log:** 2026-07-05T03:21:01-04:00 (3240473 bytes)
...
- **Último log:** 2026-07-04T12:47:02-04:00 (1567 bytes)
...
- **Último log:** 2026-07-05T03:23:01-04:00 (167824 bytes)
...
- **Último log:** 2026-07-05T01:41:53-04:00 (15338 bytes)
...
- **Último log:** 2026-07-04T20:37:03-04:00 (8939 bytes)
...
- **Último log:** 2026-07-05T03:15:01-04:00 (407376 bytes)
...
- **Último log:** 2026-07-05T03:00:01-04:00 (80798 bytes)
...
- **Último log:** 2026-07-05T03:17:04-04:00 (13962 bytes)
...
- **Último log:** 2026-07-04T08:00:02-04:00 (2567 bytes)
...
- **Último log:** 2026-07-05T03:00:01-04:00 (35432 bytes)
...
- **Último log:** 2026-07-05T03:15:01-04:00 (989510 bytes)
...
- **Último log:** 2026-07-04T08:10:01-04:00 (1978 bytes)
...
- **Último log:** 2026-07-05T03:15:01-04:00 (139910 bytes)
...
- **Último log:** 2026-07-05T03:20:01-04:00 (483826 bytes)
...
- **Último log:** 2026-07-04T20:07:02-04:00 (14892 bytes)
...
- **Último log:** 2026-07-04T03:41:01-04:00 (3335 bytes)
...
- **Último log:** 2026-07-05T03:15:43-04:00 (412503 bytes)
...
- **Último log:** 2026-07-04T09:16:02-04:00 (815 bytes)
...
- **Último log:** 2026-07-05T03:15:03-04:00 (62463 bytes)
...
- **Último log:** 2026-07-05T03:20:02-04:00 (52230 bytes)

### `monitor-sb-restricted-pages.sh`
- **Frequência:** `0 8,16 * * *`
- **Owner:** Zeus/Infra
- **Risco:** não classificado
- **Função:** Sem descrição cadastrada.
- **Comando:** `flock -n /var/lock/monitor_sb_restricted_pages.lock /root/mgs-agent/scripts/monitor-sb-restricted-pages.sh >> /root/mgs-agent/logs/monitor-sb-restricted-pages.log 2>&1`
- **Log:** `/root/mgs-agent/logs/monitor-sb-restricted-pages.log`
- **Último log:** 2026-07-04T16:00:13-04:00 (4390 bytes)
...
- **Último log:** 2026-07-05T03:22:01-04:00 (2860 bytes)
