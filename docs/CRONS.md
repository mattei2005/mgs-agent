...
Gerado em: `2026-06-05T08:10:01-04:00`  
...
------------------- | ------------------------------ | -------------- | --------------------------------------- | ----- | -------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-06-05T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-06-05T07:56:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=2e98548
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-06-05 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-06-05T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-06-05T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas    | sim   | [2026-06-05T08:00:01-0400] OK total closed zombie sessions: 0 (grace=30min)
17 3 * * *          | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta arquivos .bak antigos      | sim   | [2026-06-05T03:17:04-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-06-05T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-06-05T12:00:01Z] cron-stale check: jobs=19 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-06-05T12:05:02.481675Z done posted=0 skipped=0 candidates=0 last_seen_id=1512254708566462484
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | não classificado                        | sim   | [2026-06-05T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
```
...
- **Último log:** 2026-06-05T08:10:01-04:00 (20419 bytes)
...
- **Último log:** 2026-06-05T07:56:02-04:00 (6112 bytes)
...
- **Último log:** 2026-06-05T00:00:07-04:00 (0 bytes)
...
- **Último log:** 2026-06-05T08:07:02-04:00 (4158 bytes)
...
- **Último log:** 2026-06-05T08:06:01-04:00 (34006 bytes)
...
- **Último log:** 2026-06-05T08:08:01-04:00 (3332 bytes)
...
- **Último log:** 2026-06-05T05:00:04-04:00 (579 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (7840 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (608 bytes)
...
- **Último log:** 2026-06-05T03:17:04-04:00 (240 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (15200 bytes)
...
- **Último log:** 2026-06-05T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-06-05T08:05:02-04:00 (9506 bytes)
...
- **Último log:** 2026-06-05T08:07:02-04:00 (292 bytes)
