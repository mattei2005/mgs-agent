...
Gerado em: `2026-09-04T08:32:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-04T08:30:02-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-04T08:27:47-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=a5052368
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-04 08:22:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-04T08:31:01-04:00 [monitor-service-restarts] OK
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-03T20:37:02-04:00] OK no_changes upstream=63279301bc (last_notified=6327930)
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                                | sim   | [2026-09-04T08:30:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                             | sim   | [2026-09-04T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                                | sim   | [2026-09-04T12:30:01Z] cron-stale check: jobs=45 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                                | sim   | 2026-09-04T12:30:01.726159Z done posted=0 skipped=0 candidates=0 last_seen_id=1545171587068862500
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                      | sim   | [2026-09-04T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                             | sim   | [2026-09-04T08:30:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                                 | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-04T12:27:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1545309294772232273
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                       | sim   | {"status": "SYNC_OK", "target_date": "2026-09-03", "groups": 13, "source_rows": 13, "revenue_cents": 492728, "net_revenue_cents": 443456, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                                 | sim   | {"scanned": 412, "processed": 0, "status_counts": {"already_closed": 325, "already_quarantined": 87}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=288318 sent=623182 notification=none message_id=none
3-58/5 13,14 * * 5       | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=288318 sent=623182 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                              | sim   | 2026-09-04T12:31:01.647600Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                             | sim   | 2026-09-04T08:47:01.813953+00:00 status=ok profiles=3 errors=0 max_context_percent=21.86 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                             | sim   | {"status":"SYNC_OK","started_at_et":"2026-09-04T08:17:01-04:00","completed_at_et":"2026-09-04T08:17:09-04:00","period_start":"2026-08-29","period_end":"2026-09-04","publishers":45,"api_rows":7259,"named_profiles":144,"da
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada ao vivo; estado local só faz cursor/dedupe, sem replay; envia apenas notificações novas/reabertas | sim   | {"ok": true, "mode": "noop", "last_seen_id": 680551, "alerts_seen": 319, "new_alerts": 0, "refreshed_incidents": 0, "daily": {"date": "2026-09-04", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_s
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | médio: exclusão limitada de mensagens Discord anteriores ao dia anterior, com readback                                           | sim   | {"ok": true, "mode": "retention-apply", "cutoff": "2026-09-03T00:00:00-04:00", "scanned": 3, "eligible": 0, "would_delete": 0, "deleted": 0, "already_missing": 0, "remaining": 0, "message_ids": []}
...
- **Último log:** 2026-09-04T08:30:02-04:00 (12855590 bytes)
...
- **Último log:** 2026-09-04T08:27:47-04:00 (2146593 bytes)
...
- **Último log:** 2026-09-04T08:22:03-04:00 (970799 bytes)
...
- **Último log:** 2026-09-04T08:31:01-04:00 (13063687 bytes)
...
- **Último log:** 2026-09-04T08:28:01-04:00 (766972 bytes)
...
- **Último log:** 2026-09-04T05:00:13-04:00 (38423 bytes)
...
- **Último log:** 2026-09-03T20:37:02-04:00 (50917 bytes)
...
- **Último log:** 2026-09-04T08:30:01-04:00 (1846506 bytes)
...
- **Último log:** 2026-09-04T08:00:01-04:00 (45037 bytes)
...
- **Último log:** 2026-09-04T08:00:01-04:00 (11929 bytes)
...
- **Último log:** 2026-09-04T08:00:01-04:00 (161508 bytes)
...
- **Último log:** 2026-09-04T08:30:02-04:00 (639370 bytes)
...
- **Último log:** 2026-09-04T08:30:01-04:00 (3443785 bytes)
...
- **Último log:** 2026-09-04T08:07:02-04:00 (68620 bytes)
...
- **Último log:** 2026-09-04T03:42:03-04:00 (22301 bytes)
...
- **Último log:** 2026-09-03T22:54:01-04:00 (640713 bytes)
...
- **Último log:** 2026-09-04T08:30:02-04:00 (929359 bytes)
...
- **Último log:** 2026-09-04T08:30:03-04:00 (1511151 bytes)
...
- **Último log:** 2026-09-04T08:27:02-04:00 (2292818 bytes)
...
- **Último log:** 2026-09-04T06:53:36-04:00 (302180 bytes)
...
- **Último log:** 2026-09-04T07:39:01-04:00 (130636 bytes)
...
- **Último log:** 2026-09-04T08:19:02-04:00 (322371 bytes)
...
- **Último log:** 2026-09-04T08:00:12-04:00 (34615 bytes)
...
- **Último log:** 2026-09-04T08:31:01-04:00 (14254491 bytes)
...
- **Último log:** 2026-09-04T08:32:01-04:00 (5783164 bytes)
...
- **Último log:** 2026-09-04T08:05:14-04:00 (311207 bytes)
...
- **Último log:** 2026-09-04T08:29:17-04:00 (16929651 bytes)
...
- **Último log:** 2026-09-04T08:00:05-04:00 (16176 bytes)
...
- **Último log:** 2026-09-04T08:24:14-04:00 (83278 bytes)
...
- **Último log:** 2026-09-04T08:24:01-04:00 (1308049 bytes)
...
- **Último log:** 2026-09-04T08:31:02-04:00 (13099214 bytes)
...
- **Último log:** 2026-09-04T04:47:14-04:00 (6608 bytes)
...
- **Último log:** 2026-09-04T08:30:02-04:00 (682117 bytes)
...
- **Último log:** 2026-09-04T08:27:13-04:00 (190550 bytes)
...
- **Último log:** 2026-09-04T00:05:02-04:00 (2308 bytes)
