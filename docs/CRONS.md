...
Gerado em: `2026-07-04T08:10:01-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-04T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-04T07:56:08-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=4cc770df
...
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-04 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-04T08:06:01-04:00 [monitor-service-restarts] OK
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                                | sim   | [2026-07-03T20:37:02-04:00] OK notified upstream=5445e42b8 local=efd87a154 behind=613 days=3 feat=56 fix=360 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-04T08:00:02-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-04T08:00:01-0400] DONE total closed zombie sessions: 3 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-04T12:00:02Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-04T12:00:02Z] cron-stale check: jobs=25 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-04T12:05:01.745885Z done posted=0 skipped=0 candidates=0 last_seen_id=1522763996925657214
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-04T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-04T08:00:46-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra     | não classificado                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares", "hera"], "checked": 12, "stale": 0, "archived": 0, "skipped_recent": 12, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-04T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
0 8,16 * * *        | monitor-sb-restricted-pages.sh             | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-04T08:00:15-04:00] monitor-sb-restricted-pages: OK
```
...
- **Último log:** 2026-07-04T08:10:01-04:00 (1721183 bytes)
...
- **Último log:** 2026-07-04T07:56:08-04:00 (567069 bytes)
...
- **Último log:** 2026-07-04T08:07:03-04:00 (197022 bytes)
...
- **Último log:** 2026-07-04T08:06:01-04:00 (3084721 bytes)
...
- **Último log:** 2026-07-04T08:08:01-04:00 (160004 bytes)
...
- **Último log:** 2026-07-03T20:37:02-04:00 (8467 bytes)
...
- **Último log:** 2026-07-04T08:00:02-04:00 (388511 bytes)
...
- **Último log:** 2026-07-04T08:00:02-04:00 (71094 bytes)
...
- **Último log:** 2026-07-04T08:00:01-04:00 (33798 bytes)
...
- **Último log:** 2026-07-04T08:00:02-04:00 (939845 bytes)
...
- **Último log:** 2026-07-04T08:00:02-04:00 (133365 bytes)
...
- **Último log:** 2026-07-04T08:05:01-04:00 (461188 bytes)
...
- **Último log:** 2026-07-04T08:07:02-04:00 (14308 bytes)
...
- **Último log:** 2026-07-04T08:00:46-04:00 (390192 bytes)
...
- **Último log:** 2026-07-04T08:00:04-04:00 (50530 bytes)
...
- **Último log:** 2026-07-04T08:05:02-04:00 (32510 bytes)
...
- **Último log:** 2026-07-04T08:00:15-04:00 (3989 bytes)
