...
Gerado em: `2026-05-28T18:28:46-04:00`  
...
------------ | ------------------------------ | -------------- | --------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------
*/5 * * * *  | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-28T18:25:01-04:00 synced ares skills/growth
*/15 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-28T18:15:01-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=n/a
0 10 * * *   | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | [2026-05-28T10:00:16-04:00] monitor-yoast-health-eggbev: ERRO CRÍTICO: Webhook URL vazio após 3 tentativas — abortando
*/15 * * * * | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-28 18:15:01] check-pending-reports.sh concluído
*/5 * * * *  | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-28T18:25:02-04:00 [monitor-service-restarts] OK
0 12 * * *   | monitor-gpt55-oauth-cost.sh    | Zeus/Infra     | baixo                                   | sim   | Zeus: 564 calls / Atena: 3 calls
*/5 * * * *  | monitor-tool-loops.sh          | Zeus/Infra     | baixo                                   | sim   | Loop detector: 0 alertas enviados
0 5 * * *    | infra-discovery.sh             | Zeus/Infra     | médio: sobrescreve infra-inventory.json | sim   | [05:00:04] === infra-discovery.sh DONE ===
0 8 * * *    | monitor-hermes-updates.sh      | Zeus/Infra     | baixo                                   | sim   | [2026-05-28T18:28:46-04:00] OK already_uptodate local=11d93096b
*/15 * * * * | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-28T18:00:01-0400]   est_input_tokens=240000  est_output_tokens=60000  method=duration_estimated
0 * * * *    | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas    | sim   | [2026-05-28T16:00:01-0400] OK total closed zombie sessions: 0 (grace=30min)
0 3 * * *    | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta arquivos .bak antigos      | sim   | [2026-05-28T03:00:03-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * * | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-28T22:15:01Z] done: all profiles in sync, nothing to do
10 8 * * *   | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=18 generated_at=2026-05-28T08:10:02-04:00
*/15 * * * * | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-28T22:15:01Z] cron-stale check: jobs=18 problems=1 resolved=0 alerts_sent=0
*/5 * * * *  | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-28T22:25:01.656047Z done posted=0 skipped=0 candidates=0 last_seen_id=1509527995596148817
```
...
- **Último log:** 2026-05-28T18:25:01-04:00 (63479 bytes)
...
- **Último log:** 2026-05-28T18:15:01-04:00 (9350 bytes)
...
- **Último log:** 2026-05-28T10:00:16-04:00 (411 bytes)
...
- **Último log:** 2026-05-28T18:15:02-04:00 (8460 bytes)
...
- **Último log:** 2026-05-28T18:25:02-04:00 (59247 bytes)
...
- **Último log:** 2026-05-28T12:00:05-04:00 (87 bytes)
...
- **Último log:** 2026-05-28T18:25:01-04:00 (5134 bytes)
...
- **Último log:** 2026-05-28T05:00:04-04:00 (578 bytes)
...
- **Último log:** 2026-05-28T18:28:46-04:00 (295 bytes)
...
- **Último log:** 2026-05-28T18:15:01-04:00 (21289 bytes)
...
- **Último log:** 2026-05-28T18:00:01-04:00 (1340 bytes)
...
- **Último log:** 2026-05-28T03:00:03-04:00 (240 bytes)
...
- **Último log:** 2026-05-28T08:00:02-04:00 (151 bytes)
...
- **Último log:** 2026-05-28T18:00:01-04:00 (1548 bytes)
...
- **Último log:** 2026-05-28T18:15:01-04:00 (39055 bytes)
...
- **Último log:** 2026-05-28T08:10:02-04:00 (86 bytes)
...
- **Último log:** 2026-05-28T18:15:01-04:00 (6205 bytes)
...
- **Último log:** 2026-05-28T18:25:01-04:00 (21756 bytes)
