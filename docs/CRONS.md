...
Gerado em: `2026-08-18T08:10:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ---------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-18T08:05:02-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-18T07:57:05-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=ec8e5cd2
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                                | sim   | [2026-08-17T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (post_type=weekly). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 total=290 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-18 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-18T08:06:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                | sim   | Monitor GPT-5.6 OAuth enviado: calls=808 sessions=32 input=4167235 output=390648 actual_usd=0.00 hypothetical_usd=37.37 config_ok=True billing_ok=False message_id=1538938967532118017
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-17T20:37:03-04:00] OK notified upstream=46c0c6ec4 local=72bb67328 behind=119 new_since_last=100 days=0 feat=29 fix=63 breaking=0
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                    | sim   | [2026-08-18T08:00:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                 | sim   | [2026-08-18T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
44 20 * * 2,5            | housekeeping-bak-cleanup.sh                | Zeus/Infra        | alto: deleta backups antigos, preservando último por família                                         | sim   | [2026-08-14T20:44:04-04:00] housekeeping: === END (no-op) ===
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=42 generated_at=2026-08-17T08:10:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                    | sim   | [2026-08-18T12:00:01Z] cron-stale check: jobs=42 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                    | sim   | 2026-08-18T12:05:01.946924Z done posted=0 skipped=0 candidates=0 last_seen_id=1539071439603368010
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                          | sim   | [2026-08-18T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *               | mgs-safety-backup.sh                       | Zeus/Infra        | alto: cria snapshot e remove automaticamente safety backups além do mais recente                     | sim   | [2026-08-15T03:42:01-04:00] mgs-safety-backup: END OK archive=/root/mgs-agent/backups/safety/mgs-safety-20260815-034101.tar.gz size=1216.49MB manifest=/root/mgs-agent/backups/safety/mgs-safety-20260815-034101.manifest.tx
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-17T22:54:25-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *             | discord-archive-stale-agent-threads.py     | Zeus/Infra        | não classificado                                                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares"], "checked": 13, "stale": 0, "archived": 0, "skipped_recent": 13, "errors": 0}}
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                 | sim   | [2026-08-18T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-18T12:07:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1539226163174449233
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                     | sim   | "errors": []
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                             | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.00% account:read_write=0.82%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback           | sim   | {"status": "SYNC_OK", "target_date": "2026-08-17", "groups": 7, "source_rows": 7, "revenue_cents": 83040, "net_revenue_cents": 74736, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_date"
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                     | sim   | {"scanned": 335, "processed": 0, "status_counts": {"already_closed": 266, "already_quarantined": 69}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=190103 sent=346397 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=190103 sent=346397 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                  | sim   | 2026-08-18T12:09:02.087162Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                 | sim   | 2026-08-18T08:47:01.611947+00:00 status=ok profiles=3 errors=0 max_context_percent=157.48 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-18T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-18T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
10 23 * * *              | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-18T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback | sim   | {"status":"SYNC_OK","started_at_et":"2026-08-17T08:17:02-04:00","completed_at_et":"2026-08-17T08:17:12-04:00","period_start":"2026-08-11","period_end":"2026-08-17","publishers":45,"api_rows":7168,"named_profiles":153,"da
```
...
- **Último log:** 2026-08-18T08:05:02-04:00 (8424872 bytes)
...
- **Último log:** 2026-08-18T07:57:05-04:00 (1598102 bytes)
...
- **Último log:** 2026-08-17T10:23:08-04:00 (66829 bytes)
...
- **Último log:** 2026-08-18T08:07:03-04:00 (757824 bytes)
...
- **Último log:** 2026-08-18T08:06:01-04:00 (10428778 bytes)
...
- **Último log:** 2026-08-17T11:54:02-04:00 (8360 bytes)
...
- **Último log:** 2026-08-18T08:08:01-04:00 (600474 bytes)
...
- **Último log:** 2026-08-18T05:00:11-04:00 (27384 bytes)
...
- **Último log:** 2026-08-17T20:37:03-04:00 (37337 bytes)
...
- **Último log:** 2026-08-18T08:00:01-04:00 (1446421 bytes)
...
- **Último log:** 2026-08-18T08:00:01-04:00 (40755 bytes)
...
- **Último log:** 2026-08-14T20:44:04-04:00 (20466 bytes)
...
- **Último log:** 2026-08-18T08:00:01-04:00 (9362 bytes)
...
- **Último log:** 2026-08-18T08:00:01-04:00 (126506 bytes)
...
- **Último log:** 2026-08-17T08:10:02-04:00 (2838 bytes)
...
- **Último log:** 2026-08-18T08:00:03-04:00 (500565 bytes)
...
- **Último log:** 2026-08-18T08:05:01-04:00 (2605546 bytes)
...
- **Último log:** 2026-08-18T08:07:02-04:00 (53728 bytes)
...
- **Último log:** 2026-08-18T03:41:01-04:00 (16493 bytes)
...
- **Último log:** 2026-08-17T22:54:25-04:00 (621536 bytes)
...
- **Último log:** 2026-08-17T09:16:02-04:00 (5523 bytes)
...
- **Último log:** 2026-08-18T08:00:04-04:00 (689308 bytes)
...
- **Último log:** 2026-08-18T08:05:02-04:00 (1106897 bytes)
...
- **Último log:** 2026-08-18T08:07:01-04:00 (1657466 bytes)
...
- **Último log:** 2026-08-18T06:55:14-04:00 (230418 bytes)
...
- **Último log:** 2026-08-18T07:39:01-04:00 (90645 bytes)
...
- **Último log:** 2026-08-18T07:49:02-04:00 (219429 bytes)
...
- **Último log:** 2026-08-18T08:00:16-04:00 (24893 bytes)
...
- **Último log:** 2026-08-18T08:09:02-04:00 (9373825 bytes)
...
- **Último log:** 2026-08-18T08:10:01-04:00 (2744337 bytes)
...
- **Último log:** 2026-08-18T08:05:14-04:00 (204801 bytes)
...
- **Último log:** 2026-08-18T07:59:17-04:00 (10805687 bytes)
...
- **Último log:** 2026-08-18T07:24:03-04:00 (55351 bytes)
...
- **Último log:** 2026-08-18T08:04:02-04:00 (852996 bytes)
...
- **Último log:** 2026-08-18T08:09:02-04:00 (8127338 bytes)
...
- **Último log:** 2026-08-18T04:47:09-04:00 (4004 bytes)
...
- **Último log:** 2026-08-18T08:01:25-04:00 (280026 bytes)
...
- **Último log:** 2026-08-17T08:17:14-04:00 (6353 bytes)
