...
Gerado em: `2026-07-06T08:10:02-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-06T08:10:02-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-06T07:56:14-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=31ab4ab8
23 10 * * *         | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo | baixo                                                                | sim   | [2026-07-05T10:23:03-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-06 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-06T08:06:01-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                                | sim   | Zeus 675 Atena 0 Ares 0 Hera 0
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                                | sim   | [2026-07-05T20:37:02-04:00] OK notified upstream=6fad6f1dd local=a05b64d67 behind=1 days=0 feat=0 fix=1 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-06T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-06T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família         | sim   | [2026-07-06T03:17:02-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-06T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py                      | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=27 generated_at=2026-07-05T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-06T12:00:01Z] cron-stale check: jobs=27 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-06T12:05:01.688604Z done posted=0 skipped=0 candidates=0 last_seen_id=1523557957462130920
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-06T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-06T08:00:43-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-06T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
0 8,16 * * *        | monitor-sb-restricted-pages.sh             | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-06T08:00:13-04:00] monitor-sb-restricted-pages: OK
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-06T12:07:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1523585335999860888
```
...
- **Último log:** 2026-07-06T08:10:02-04:00 (1934969 bytes)
...
- **Último log:** 2026-07-06T07:56:14-04:00 (605881 bytes)
...
- **Último log:** 2026-07-05T10:23:03-04:00 (9323 bytes)
...
- **Último log:** 2026-07-06T08:07:02-04:00 (221214 bytes)
...
- **Último log:** 2026-07-06T08:06:01-04:00 (3467953 bytes)
...
- **Último log:** 2026-07-05T12:47:02-04:00 (1659 bytes)
...
- **Último log:** 2026-07-06T08:08:01-04:00 (179554 bytes)
...
- **Último log:** 2026-07-06T05:00:10-04:00 (16518 bytes)
...
- **Último log:** 2026-07-05T20:37:02-04:00 (9460 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (435551 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (53970 bytes)
...
- **Último log:** 2026-07-06T03:17:02-04:00 (14271 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (2869 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (37926 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (1063685 bytes)
...
- **Último log:** 2026-07-05T08:10:01-04:00 (2064 bytes)
...
- **Último log:** 2026-07-06T08:00:01-04:00 (149685 bytes)
...
- **Último log:** 2026-07-06T08:05:01-04:00 (517636 bytes)
...
- **Último log:** 2026-07-06T08:07:02-04:00 (16060 bytes)
...
- **Último log:** 2026-07-06T03:43:24-04:00 (4015 bytes)
...
- **Último log:** 2026-07-06T08:00:43-04:00 (445893 bytes)
...
- **Último log:** 2026-07-05T09:16:02-04:00 (922 bytes)
...
- **Último log:** 2026-07-06T08:00:03-04:00 (80288 bytes)
...
- **Último log:** 2026-07-06T08:05:02-04:00 (80713 bytes)
...
- **Último log:** 2026-07-06T08:00:14-04:00 (5546 bytes)
...
- **Último log:** 2026-07-06T08:07:01-04:00 (47710 bytes)
