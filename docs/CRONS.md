...
Gerado em: `2026-05-25T08:10:01-04:00`  
...
------------ | ------------------------------ | -------------- | --------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------
*/5 * * * *  | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-25T08:10:01-04:00 synced zeus skills/ops
*/15 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-25T08:00:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=8dbcc79
0 10 * * *   | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
*/15 * * * * | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-25 08:00:01] check-pending-reports.sh concluído
*/5 * * * *  | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-25T08:05:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * * | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-25T08:00:01-0400] Mode: ALL pending
...
*/15 * * * * | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-25T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *   | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | (sem log útil ainda)
*/15 * * * * | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-25T12:00:01Z] cron-stale check: jobs=18 problems=0 resolved=0 alerts_sent=0
*/5 * * * *  | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-25T12:05:01.461409Z done posted=0 skipped=0 candidates=0 last_seen_id=1508331344558686228
```
...
- **Último log:** 2026-05-25T08:10:01-04:00 (15375 bytes)
...
- **Último log:** 2026-05-25T08:00:02-04:00 (6219 bytes)
...
- **Último log:** 2026-05-25T00:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-05-25T08:00:02-04:00 (4158 bytes)
...
- **Último log:** 2026-05-25T08:05:01-04:00 (34006 bytes)
...
- **Último log:** 2026-05-25T08:05:01-04:00 (3332 bytes)
...
- **Último log:** 2026-05-25T08:00:01-04:00 (4512 bytes)
...
- **Último log:** 2026-05-25T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-05-25T08:00:01-04:00 (12320 bytes)
...
- **Último log:** 2026-05-25T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-05-25T08:05:01-04:00 (9604 bytes)
