...
Gerado em: `2026-07-09T08:10:02-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-09T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-09T07:56:23-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=73d31de8
23 10 * * *         | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo | baixo                                                                | sim   | [2026-07-08T10:23:03-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-09 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-09T08:06:02-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                                | sim   | Zeus 654 Atena 0 Ares 0 Hera 0
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                                | sim   | [2026-07-08T20:37:03-04:00] OK notified upstream=56a8e81d3 local=009b42d00 behind=164 days=1 feat=34 fix=75 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-09T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-09T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família         | sim   | [2026-07-09T03:17:04-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-09T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py                      | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=26 generated_at=2026-07-08T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-09T12:00:01Z] cron-stale check: jobs=27 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-09T12:05:07.106770Z done posted=0 skipped=0 candidates=0 last_seen_id=1524575895929491548
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-09T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-09T08:00:32-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra     | não classificado                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares", "hera"], "checked": 13, "stale": 0, "archived": 0, "skipped_recent": 13, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-09T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-09T12:07:01Z] alerts-infra-failed-alert-resolver: DONE candidates=1 handled=0 skipped=1 last_seen_id=1524748463634383001
...
- **Último log:** 2026-07-09T08:10:01-04:00 (2255815 bytes)
...
- **Último log:** 2026-07-09T07:56:23-04:00 (675622 bytes)
...
- **Último log:** 2026-07-08T10:23:03-04:00 (10715 bytes)
...
- **Último log:** 2026-07-09T08:07:02-04:00 (257441 bytes)
...
- **Último log:** 2026-07-09T08:06:02-04:00 (4105109 bytes)
...
- **Último log:** 2026-07-08T12:47:02-04:00 (1936 bytes)
...
- **Último log:** 2026-07-09T08:08:01-04:00 (208930 bytes)
...
- **Último log:** 2026-07-09T05:00:10-04:00 (4720 bytes)
...
- **Último log:** 2026-07-08T20:37:03-04:00 (11038 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (506111 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (47211 bytes)
...
- **Último log:** 2026-07-09T03:17:04-04:00 (15637 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (3322 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (44118 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (1249445 bytes)
...
- **Último log:** 2026-07-08T08:10:01-04:00 (2322 bytes)
...
- **Último log:** 2026-07-09T08:00:01-04:00 (174165 bytes)
...
- **Último log:** 2026-07-09T08:05:07-04:00 (632256 bytes)
...
- **Último log:** 2026-07-09T08:07:02-04:00 (18688 bytes)
...
- **Último log:** 2026-07-09T03:41:01-04:00 (4803 bytes)
...
- **Último log:** 2026-07-09T08:00:32-04:00 (530620 bytes)
...
- **Último log:** 2026-07-08T09:16:02-04:00 (1243 bytes)
...
- **Último log:** 2026-07-09T08:00:03-04:00 (124928 bytes)
...
- **Último log:** 2026-07-09T08:05:02-04:00 (151947 bytes)
...
- **Último log:** 2026-07-09T08:07:01-04:00 (159770 bytes)
...
- **Último log:** 2026-07-09T06:55:48-04:00 (9342 bytes)
