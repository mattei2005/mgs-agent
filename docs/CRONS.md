...
Gerado em: `2026-06-23T10:29:44-04:00`
Fonte: `root crontab + script/log stat, read-only`
Total MGS ativo no root crontab: **21**
...
------------------- | ------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                             | sim   | 2026-06-23T10:25:01-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                             | sim   | [2026-06-23T10:26:03-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=e04ab36a
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                             | sim   | [2026-06-23T10:23:03-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-23 10:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                             | sim   | 2026-06-23T10:26:01-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh    | Zeus/Infra     | baixo                                                             | sim   | Zeus 71 Atena 0 Ares 70 Hera 0
3-58/5 * * * *      | monitor-tool-loops.sh          | Zeus/Infra     | baixo                                                             | sim   | Loop detector: 0 alertas enviados
0 5 * * *           | infra-discovery.sh             | Zeus/Infra     | médio: sobrescreve infra-inventory.json                           | sim   | [05:00:08] === infra-discovery.sh DONE ===
37 8,14,20 * * *    | monitor-hermes-updates.sh      | Zeus/Infra     | baixo                                                             | sim   | [2026-06-23T08:37:02-04:00] OK notified upstream=5ecf3bf0e local=ac83365d9 behind=359 days=2 feat=47 fix=219 breaking=0
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-23T10:15:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-23T10:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta backups antigos, preservando último por família      | sim   | [2026-06-23T03:17:04-04:00] housekeeping:   rm /root/mgs-agent/scripts/mgs-rec-runner.py.bak-atena-contract-v2-20260608-144126
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-23T14:15:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                 | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=21 generated_at=2026-06-23T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-23T14:15:01Z] cron-stale check: jobs=21 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-23T14:25:02.031243Z done posted=0 skipped=0 candidates=0 last_seen_id=1518958902782201989
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia       | sim   | [2026-06-23T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *          | mgs-safety-backup.sh           | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão              | sim   | [2026-06-23T03:41:01-04:00] mgs-safety-backup: SKIP: último backup ainda dentro do intervalo de 3 dias: /root/mgs-agent/backups/safety/mgs-safety-20260620-034101.tar.gz
*/15 * * * *        | monitor-honcho-health.sh       | Zeus/Infra     | não classificado                                                  | sim   | [2026-06-23T10:17:08-04:00] monitor-honcho-health: DONE status=ok failures=0
```
...
- **Último log:** 2026-06-23T10:25:01-04:00 (555750 bytes)
...
- **Último log:** 2026-06-23T10:26:03-04:00 (189214 bytes)
...
- **Último log:** 2026-06-23T10:23:03-04:00 (3755 bytes)
...
- **Último log:** 2026-06-23T10:22:02-04:00 (65772 bytes)
...
- **Último log:** 2026-06-23T10:26:01-04:00 (1026322 bytes)
...
- **Último log:** 2026-06-22T12:47:02-04:00 (470 bytes)
...
- **Último log:** 2026-06-23T10:28:01-04:00 (53244 bytes)
...
- **Último log:** 2026-06-23T05:00:08-04:00 (3538 bytes)
...
- **Último log:** 2026-06-23T08:37:02-04:00 (2818 bytes)
...
- **Último log:** 2026-06-23T10:15:01-04:00 (127890 bytes)
...
- **Último log:** 2026-06-23T10:00:01-04:00 (63385 bytes)
...
- **Último log:** 2026-06-23T03:17:04-04:00 (6753 bytes)
...
- **Último log:** 2026-06-23T08:00:02-04:00 (906 bytes)
...
- **Último log:** 2026-06-23T10:00:01-04:00 (11266 bytes)
...
- **Último log:** 2026-06-23T10:15:01-04:00 (294930 bytes)
...
- **Último log:** 2026-06-23T08:10:01-04:00 (602 bytes)
...
- **Último log:** 2026-06-23T10:15:01-04:00 (44370 bytes)
...
- **Último log:** 2026-06-23T10:25:02-04:00 (153468 bytes)
...
- **Último log:** 2026-06-23T08:07:02-04:00 (4672 bytes)
...
- **Último log:** 2026-06-23T03:41:01-04:00 (1055 bytes)
...
- **Último log:** 2026-06-23T10:17:08-04:00 (65949 bytes)
