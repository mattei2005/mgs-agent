...
Gerado em: `2026-07-10T22:31:15-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-10T22:30:02-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-10T22:26:29-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=128a0662
...
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-10 22:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-10T22:31:02-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                                | sim   | Zeus 705 Atena 0 Ares 1 Hera 48
...
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-10T22:30:02-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-10T22:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família         | sim   | [2026-07-10T03:17:03-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-11T02:30:02Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-11T02:30:02Z] cron-stale check: jobs=28 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-11T02:30:02.277800Z done posted=0 skipped=0 candidates=0 last_seen_id=1525300637930094623
...
30 8,13,18,22 * * * | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-10T22:30:55-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra     | não classificado                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares", "hera"], "checked": 20, "stale": 0, "archived": 0, "skipped_recent": 20, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-10T22:30:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-11T02:27:01Z] alerts-infra-failed-alert-resolver: DONE candidates=1 handled=0 skipped=1 last_seen_id=1525327445346226278
20 6 * * *          | dtr-sb-daily-match-audit.sh                | Zeus/Infra     | não classificado                                                     | sim   | "op_errors": [],
39 * * * *          | monitor-op-rate-limit.py                   | Zeus/Infra     | baixo: consulta read-only + alerta Discord por transição             | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=14.79% account:read_write=2.96%
```
...
- **Último log:** 2026-07-10T22:30:02-04:00 (2468350 bytes)
...
- **Último log:** 2026-07-10T22:26:29-04:00 (710435 bytes)
...
- **Último log:** 2026-07-10T22:22:03-04:00 (277061 bytes)
...
- **Último log:** 2026-07-10T22:31:02-04:00 (4427265 bytes)
...
- **Último log:** 2026-07-10T22:28:01-04:00 (224570 bytes)
...
- **Último log:** 2026-07-10T22:30:02-04:00 (543841 bytes)
...
- **Último log:** 2026-07-10T22:00:02-04:00 (67946 bytes)
...
- **Último log:** 2026-07-10T22:00:01-04:00 (47386 bytes)
...
- **Último log:** 2026-07-10T22:30:02-04:00 (1348775 bytes)
...
- **Último log:** 2026-07-10T22:30:02-04:00 (187255 bytes)
...
- **Último log:** 2026-07-10T22:30:02-04:00 (711087 bytes)
...
- **Último log:** 2026-07-10T22:30:55-04:00 (577937 bytes)
...
- **Último log:** 2026-07-10T22:30:03-04:00 (148798 bytes)
...
- **Último log:** 2026-07-10T22:30:03-04:00 (191559 bytes)
...
- **Último log:** 2026-07-10T22:27:01-04:00 (219310 bytes)
...
- **Último log:** 2026-07-10T21:39:02-04:00 (198 bytes)
