...
Gerado em: `2026-09-18T08:32:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-18T08:30:01-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-18T08:26:05-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=6d67c205a
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-18 08:22:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-18T08:31:01-04:00 [monitor-service-restarts] OK
...
0 5 * * *                | infra-discovery.sh                         | Zeus/Infra        | médio: sobrescreve infra-inventory.json                                                                                          | sim   | [05:00:15] === infra-discovery.sh DONE ===
...
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                                | sim   | [2026-09-18T08:30:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                             | sim   | [2026-09-18T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                                | sim   | [2026-09-18T12:30:01Z] cron-stale check: jobs=46 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                                | sim   | 2026-09-18T12:30:01.605899Z done posted=0 skipped=0 candidates=0 last_seen_id=1550305449251831940
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                      | sim   | [2026-09-18T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 2,8,14,20 * * *       | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-18T02:54:02-04:00] monitor-honcho-health: SKIP healthy: paid canary is due once daily at hour=8
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                             | sim   | [2026-09-18T08:30:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                                 | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-18T12:27:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1550407693812891753
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                                                 | sim   | "op_errors": [],
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                                                         | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.00% account:read_write=0.05%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                       | sim   | {"status": "SYNC_OK", "target_date": "2026-09-17", "groups": 13, "source_rows": 13, "revenue_cents": 79191, "net_revenue_cents": 71272, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_dat
...
0 8,14,20 * * *          | refresh-sb-restricted-history-sheet.py     | Zeus/Infra        | não classificado                                                                                                                 | sim   | {"coverage_start": "2026-07-15T14:38:01-04:00", "history_rows": 619, "mode": "apply", "ok": true, "sheet_update": {"history_index": 2, "readback_ok": true, "rows_historico_restricoes": 619, "tab": "Histórico Restrições",
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=284641 sent=1064359 notification=none message_id=none
3-58/5 13,14 * * 5       | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=284641 sent=1064359 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                              | sim   | 2026-09-18T12:31:01.220641Z watchdog done dry_run=0 healthy=55 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                             | sim   | 2026-09-18T08:47:01.473843+00:00 status=ok profiles=3 errors=0 max_context_percent=31.35 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                             | sim   | {"status":"SYNC_OK","started_at_et":"2026-09-18T08:17:01-04:00","completed_at_et":"2026-09-18T08:17:10-04:00","period_start":"2026-09-12","period_end":"2026-09-18","publishers":51,"api_rows":7480,"named_profiles":127,"da
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech