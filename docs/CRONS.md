...
Gerado em: `2026-05-17T12:41:45-04:00`  
...
------------ | ------------------------------ | -------------- | --------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *  | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-17T12:40:01-04:00 synced atena skills/devops
*/15 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-17T12:30:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=e8bff96
0 10 * * *   | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | [2026-05-17T10:01:08-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢168/🟡39/🔴0 / Read: 🟢167/🟡36/🔴39 ===
*/15 * * * * | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-17 12:30:01] check-pending-reports.sh concluído
*/5 * * * *  | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-17T12:40:01-04:00 [monitor-service-restarts] OK
0 12 * * *   | monitor-gpt55-oauth-cost.sh    | Zeus/Infra     | baixo                                   | sim   | Zeus: 786 calls / Atena: 218 calls
...
*/15 * * * * | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-17T12:30:01-0400] Nothing to process. Exit.
0 * * * *    | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas    | sim   | (sem log útil ainda)
0 3 * * *    | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta arquivos .bak antigos      | sim   | [2026-05-17T03:00:05-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * * | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-17T16:30:01Z] done: all profiles in sync, nothing to do
10 8 * * *   | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=17 generated_at=2026-05-17T08:10:01-04:00
*/15 * * * * | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-17T16:30:01Z] cron-stale check: jobs=17 problems=0 resolved=0 alerts_sent=0
*/5 * * * *  | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-17T16:40:52.971800Z done posted=0 skipped=0 candidates=0 last_seen_id=1505609239987491074
```
...
- **Último log:** 2026-05-17T12:40:01-04:00 (24061 bytes)
...
- **Último log:** 2026-05-17T12:30:02-04:00 (9567 bytes)
...
- **Último log:** 2026-05-17T10:01:08-04:00 (1435 bytes)
...
- **Último log:** 2026-05-17T12:30:02-04:00 (6839 bytes)
...
- **Último log:** 2026-05-17T12:40:01-04:00 (52744 bytes)
...
- **Último log:** 2026-05-17T12:00:02-04:00 (178 bytes)
...
- **Último log:** 2026-05-17T12:40:01-04:00 (5168 bytes)
...
- **Último log:** 2026-05-17T05:00:03-04:00 (568 bytes)
...
- **Último log:** 2026-05-17T00:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-05-17T12:30:01-04:00 (10448 bytes)
...
- **Último log:** 2026-05-17T03:00:05-04:00 (240 bytes)
...
- **Último log:** 2026-05-17T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-05-17T12:00:01-04:00 (1032 bytes)
...
- **Último log:** 2026-05-17T12:30:01-04:00 (19250 bytes)
...
- **Último log:** 2026-05-17T08:10:01-04:00 (516 bytes)
...
- **Último log:** 2026-05-17T12:30:01-04:00 (11985 bytes)
...
- **Último log:** 2026-05-17T12:40:52-04:00 (98 bytes)
