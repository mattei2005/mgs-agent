...
Gerado em: `2026-09-03T08:32:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-09-03T08:30:01-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-09-03T08:27:45-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=12a1ea14
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-09-03 08:22:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-09-03T08:31:02-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                                         | sim   | Monitor GPT-5.6 OAuth enviado: calls=2713 sessions=63 input=24102915 output=1481429 actual_usd=0.00 hypothetical_usd=199.83 config_ok=False billing_ok=False message_id=1544737175579402322
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-09-02T20:37:03-04:00] OK notified upstream=593aa74c6 local=875938622 behind=825 new_since_last=144 days=2 feat=52 fix=526 breaking=0
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                             | sim   | [2026-09-03T08:30:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                          | sim   | [2026-09-03T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
32 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                                             | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=47 generated_at=2026-09-02T08:10:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                             | sim   | [2026-09-03T12:30:01Z] cron-stale check: jobs=45 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                             | sim   | 2026-09-03T12:30:01.638537Z done posted=0 skipped=0 candidates=0 last_seen_id=1544869614528237611
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                   | sim   | [2026-09-03T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                                              | sim   | [2026-09-02T22:54:09-04:00] monitor-honcho-health: DONE status=fail failures=3
...
*/15 * * * *             | discord-archive-stale-agent-threads.py     | Zeus/Infra        | não classificado                                                                                                              | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares"], "checked": 37, "stale": 0, "archived": 0, "skipped_recent": 37, "errors": 0}}
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                          | sim   | [2026-09-03T08:30:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                              | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                              | sim   | [2026-09-03T12:27:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1544904343894098024
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                    | sim   | {"status": "SYNC_OK", "target_date": "2026-09-02", "groups": 13, "source_rows": 13, "revenue_cents": 585679, "net_revenue_cents": 527112, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                              | sim   | {"scanned": 388, "processed": 0, "status_counts": {"already_closed": 316, "already_quarantined": 72}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                              | sim   | OK level=normal credits=313754 sent=597746 notification=none message_id=none
3-58/5 13,14 * * 5       | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                              | sim   | OK level=normal credits=313754 sent=597746 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                           | sim   | 2026-09-03T12:31:01.932440Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                          | sim   | 2026-09-03T08:47:01.356598+00:00 status=ok profiles=3 errors=0 max_context_percent=13.54 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                          | sim   | {"status":"SYNC_OK","started_at_et":"2026-09-03T08:17:01-04:00","completed_at_et":"2026-09-03T08:17:10-04:00","period_start":"2026-08-28","period_end":"2026-09-03","publishers":45,"api_rows":7280,"named_profiles":152,"da
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada, republica incidentes ativos uma vez por dia e envia novos/reabertos sem repetição intradiária | sim   | {"ok": true, "mode": "noop", "last_seen_id": 679953, "alerts_seen": 324, "new_alerts": 0, "refreshed_incidents": 0, "daily": {"date": "2026-09-03", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_s
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech