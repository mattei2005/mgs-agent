...
Gerado em: `2026-07-10T21:32:38-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-10T21:30:02-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-10T21:26:32-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=522c87fe
...
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-10 21:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-10T21:31:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-10T21:30:01-0400] Nothing to process. Exit.
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-11T01:30:01Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-11T01:30:01Z] cron-stale check: jobs=28 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-11T01:30:02.354643Z done posted=0 skipped=0 candidates=0 last_seen_id=1525300637930094623
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-10T21:30:52-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-10T21:30:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-11T01:32:02Z] alerts-infra-failed-alert-resolver: DONE candidates=2 handled=0 skipped=2 last_seen_id=1525313162390278194
20 6 * * *          | dtr-sb-daily-match-audit.sh                | Zeus/Infra     | não classificado                                                     | sim   | "op_errors": [],
39 * * * *          | monitor-op-rate-limit.py                   | Zeus/Infra     | baixo: consulta read-only + alerta Discord por transição             | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=10.37% account:read_write=2.07%
```
...
- **Último log:** 2026-07-10T21:30:02-04:00 (2456773 bytes)
...
- **Último log:** 2026-07-10T21:26:32-04:00 (709215 bytes)
...
- **Último log:** 2026-07-10T21:22:03-04:00 (276557 bytes)
...
- **Último log:** 2026-07-10T21:31:01-04:00 (4419417 bytes)
...
- **Último log:** 2026-07-10T21:28:01-04:00 (224162 bytes)
...
- **Último log:** 2026-07-10T21:30:01-04:00 (542861 bytes)
...
- **Último log:** 2026-07-10T21:30:01-04:00 (1346195 bytes)
...
- **Último log:** 2026-07-10T21:30:01-04:00 (186915 bytes)
...
- **Último log:** 2026-07-10T21:30:02-04:00 (709035 bytes)
...
- **Último log:** 2026-07-10T21:30:52-04:00 (576785 bytes)
...
- **Último log:** 2026-07-10T21:30:03-04:00 (148178 bytes)
...
- **Último log:** 2026-07-10T21:30:02-04:00 (190575 bytes)
...
- **Último log:** 2026-07-10T21:32:02-04:00 (217880 bytes)
