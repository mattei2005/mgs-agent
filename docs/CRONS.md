...
Gerado em: `2026-08-31T20:52:22-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-08-31T20:50:01-04:00 synced ares skills/ops/log-monitor-discord-alert
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-08-31 20:52:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-08-31T20:51:01-04:00 [monitor-service-restarts] OK
...
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                             | sim   | 2026-09-01T00:50:01.506853Z done posted=0 skipped=0 candidates=0 last_seen_id=1544144909597147329
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                          | sim   | [2026-08-31T20:50:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                              | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                              | sim   | [2026-09-01T00:52:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1544145319778979874
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                              | sim   | {"scanned": 354, "processed": 0, "status_counts": {"already_closed": 285, "already_quarantined": 69}, "log_rotated": false}
...
0 8,14,20 * * *          | refresh-sb-restricted-history-sheet.py     | Zeus/Infra        | não classificado                                                                                                              | sim   | {"coverage_start": "2026-07-15T14:38:01-04:00", "history_rows": 585, "mode": "apply", "ok": true, "sheet_update": {"history_index": 2, "readback_ok": true, "rows_historico_restricoes": 585, "tab": "Histórico Restrições",
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                           | sim   | 2026-09-01T00:52:01.882365Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
...
2-57/5 * * * *           | ares-meta-account-activity-monitor.py      | Ares/Campaign Ops | baixo: leitura Meta account-wide + estado local; Discord somente quando detectar alteração externa/não auditada               | sim   | {"ok":true,"mode":"apply","events_fetched":1,"new_external":0,"pending_after":0,"delivery_ok":null,"classifications":{"meta_or_native_rule_material_change":1},"audit_path":"data/ares/meta-ads/audit/activity-monitors/Cred
```
...
- **Último log:** 2026-08-31T20:50:01-04:00 (11948702 bytes)
...
- **Último log:** 2026-08-31T20:52:03-04:00 (927379 bytes)
...
- **Último log:** 2026-08-31T20:51:01-04:00 (12523032 bytes)
...
- **Último log:** 2026-08-31T20:00:01-04:00 (51688 bytes)
...
- **Último log:** 2026-08-31T20:00:01-04:00 (154370 bytes)
...
- **Último log:** 2026-08-31T20:50:01-04:00 (3272159 bytes)
...
- **Último log:** 2026-08-31T20:07:02-04:00 (65700 bytes)
...
- **Último log:** 2026-08-31T20:50:03-04:00 (1428118 bytes)
...
- **Último log:** 2026-08-31T20:52:02-04:00 (2161606 bytes)
...
- **Último log:** 2026-08-31T20:52:02-04:00 (13337661 bytes)
...
- **Último log:** 2026-08-31T20:52:01-04:00 (5160215 bytes)
...
- **Último log:** 2026-08-31T20:00:05-04:00 (9436 bytes)
...
- **Último log:** 2026-08-31T20:24:03-04:00 (78337 bytes)
...
- **Último log:** 2026-08-31T20:52:02-04:00 (12082184 bytes)
...
- **Último log:** 2026-08-31T20:52:02-04:00 (92263 bytes)
