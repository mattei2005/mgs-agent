...
Gerado em: `2026-06-07T00:50:54-04:00`  
...
------------------- | ------------------------------ | -------------- | ------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                        | sim   | 2026-06-07T00:50:01-04:00 synced hera skills/creative/creative-brief-handoff
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                        | sim   | [2026-06-07T00:41:01-04:00] monitor-auto-push: Concluído. consecutive_failures=3 last_ok=362c2ac
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                        | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                        | sim   | [2026-06-07 00:37:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                        | sim   | 2026-06-07T00:46:01-04:00 [monitor-service-restarts] OK
...
0 5 * * *           | infra-discovery.sh             | Zeus/Infra     | médio: sobrescreve infra-inventory.json                      | sim   | [00:40:19] === infra-discovery.sh DONE ===
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                            | sim   | [2026-06-07T00:45:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                         | sim   | [2026-06-07T00:50:16-0400] OK zeus: zero eligible zombie sessions (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                       | sim   | [2026-06-07T04:45:01Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                            | sim   | [2026-06-07T04:45:01Z] cron-stale check: jobs=20 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | não classificado                                             | sim   | 2026-06-07T04:50:01.571239Z done posted=0 skipped=0 candidates=0 last_seen_id=1513039878005330020
...
- **Último log:** 2026-06-07T00:50:01-04:00 (2870 bytes)
...
- **Último log:** 2026-06-07T00:41:01-04:00 (1187 bytes)
...
- **Último log:** 2026-06-07T00:37:02-04:00 (378 bytes)
...
- **Último log:** 2026-06-07T00:46:01-04:00 (3854 bytes)
...
- **Último log:** 2026-06-07T00:48:01-04:00 (340 bytes)
...
- **Último log:** 2026-06-07T00:40:19-04:00 (1767 bytes)
...
- **Último log:** 2026-06-07T00:45:01-04:00 (735 bytes)
...
- **Último log:** 2026-06-07T00:50:16-04:00 (3358 bytes)
...
- **Último log:** 2026-06-07T00:45:01-04:00 (1695 bytes)
...
- **Último log:** 2026-06-07T00:45:01-04:00 (255 bytes)
...
- **Último log:** 2026-06-07T00:50:01-04:00 (980 bytes)
