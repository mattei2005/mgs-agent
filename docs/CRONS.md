...
Gerado em: `2026-09-02T11:47:19-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                                     | sim   | 2026-09-02T11:45:02-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                                     | sim   | [2026-09-02T11:42:45-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=03c7f1e6
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                                                                     | sim   | [2026-09-02T10:23:07-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                                     | sim   | [2026-09-02 11:37:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                                     | sim   | 2026-09-02T11:46:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                                                     | sim   | Monitor GPT-5.6 OAuth enviado: calls=1463 sessions=31 input=12327311 output=782175 actual_usd=0.00 hypothetical_usd=102.72 config_ok=True billing_ok=False message_id=1544374784756944947
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                                                     | sim   | [2026-09-02T08:37:55-04:00] OK notified upstream=3292fbcc9 local=875938622 behind=505 new_since_last=208 days=1 feat=34 fix=325 breaking=0
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                                         | sim   | [2026-09-02T11:45:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                                      | sim   | [2026-09-02T11:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
44 20 * * 2,5            | housekeeping-bak-cleanup.sh                | Zeus/Infra        | alto: deleta backups antigos, preservando último por família                                                                              | sim   | [2026-09-01T20:44:02-04:00] housekeeping: === END (no-op) ===
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                                                         | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=47 generated_at=2026-09-02T08:10:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                                         | sim   | [2026-09-02T15:45:01Z] cron-stale check: jobs=46 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                                         | sim   | 2026-09-02T15:45:02.489355Z done posted=0 skipped=0 candidates=0 last_seen_id=1544688459648868393
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                               | sim   | [2026-09-02T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                                                          | sim   | [2026-09-02T08:54:10-04:00] monitor-honcho-health: DONE status=fail failures=3
...
*/15 * * * *             | discord-archive-stale-agent-threads.py     | Zeus/Infra        | não classificado                                                                                                                          | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares"], "checked": 33, "stale": 0, "archived": 0, "skipped_recent": 33, "errors": 0}}
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                                      | sim   | [2026-09-02T11:45:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                                          | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                                          | sim   | [2026-09-02T15:47:02Z] alerts-infra-failed-alert-resolver: DONE candidates=1 handled=0 skipped=1 last_seen_id=1544735207117037643
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                                                          | sim   | "op_errors": [],
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                                                                  | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.00% account:read_write=0.11%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                                | sim   | {"status": "SYNC_OK", "target_date": "2026-09-01", "groups": 12, "source_rows": 12, "revenue_cents": 625597, "net_revenue_cents": 563037, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                                          | sim   | {"scanned": 378, "processed": 0, "status_counts": {"already_closed": 306, "already_quarantined": 72}, "log_rotated": false}
5 8 * * *                | dtr-sb-restricted-summary.py               | Zeus/Infra        | não classificado                                                                                                                          | sim   | }
14,29,44,59 * * * *      | sb-restricted-transition-monitor.py        | Zeus/Infra        | não classificado                                                                                                                          | sim   | - cookie: __cf_bm=hbd1BbT4_jvyZmsputIIkC0FytIHjV8yNv2I4lZ76E8-1788362951.522272-1.0.1.1-X.JJKnVlGYZfVEcdHeVSyhqRqrepWJF5Zhy6SgpwkSOxftRdnYpjMPXq92m8blVv8ZlWWYDz6qdnFdzlWLodXKfDZt1M7jJTMxjODEwnCPYX7oSWJGijCFRzZXWSbAcg
0 8,14,20 * * *          | refresh-sb-restricted-history-sheet.py     | Zeus/Infra        | não classificado                                                                                                                          | sim   | {"coverage_start": "2026-07-15T14:38:01-04:00", "history_rows": 587, "mode": "apply", "ok": true, "sheet_update": {"history_index": 2, "readback_ok": true, "rows_historico_restricoes": 587, "tab": "Histórico Restrições",
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                          | sim   | OK level=normal credits=343100 sent=568400 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                          | sim   | OK level=normal credits=343100 sent=568400 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                                       | sim   | 2026-09-02T15:47:01.826111Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                                      | sim   | 2026-09-02T08:47:01.985387+00:00 status=ok profiles=3 errors=0 max_context_percent=38.86 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                                      | sim   | {"status":"SYNC_OK","started_at_et":"2026-09-02T08:17:01-04:00","completed_at_et":"2026-09-02T08:17:10-04:00","period_start":"2026-08-27","period_end":"2026-09-02","publishers":45,"api_rows":7286,"named_profiles":153,"da
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada, republica incidentes ativos uma vez por dia e envia novos/reabertos sem repetição intradiária             | sim   | {"ok": true, "mode": "noop", "last_seen_id": 679359, "alerts_seen": 325, "new_alerts": 0, "refreshed_incidents": 0, "daily": {"date": "2026-09-02", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_s
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | médio: exclusão limitada de mensagens Discord anteriores ao dia anterior, com readback                                                    | sim   | {"ok": true, "mode": "retention-apply", "cutoff": "2026-09-01T00:00:00-04:00", "scanned": 21, "eligible": 1, "would_delete": 0, "deleted": 1, "already_missing": 0, "remaining": 0, "message_ids": ["1544144310423781496"]}
2-57/5 * * * *           | ares-meta-account-activity-monitor.py      | Ares/Campaign Ops | baixo: leitura Meta account-wide + estado local; Discord somente quando detectar alteração material de outra pessoa ou ferramenta externa | sim   | {"ok":true,"mode":"apply","events_fetched":0,"new_external":0,"pending_after":0,"delivery_ok":null,"classifications":{},"audit_path":"data/ares/meta-ads/audit/activity-monitors/Creditoparaveiculo-BR-CAR-BR/run-20260902T1
3-58/5 * * * *           | eggbev-page-restriction-guardrail.sh       | Ares/Campaign Ops | alto controlado: pode pausar campanhas após pre-read, política e GET/readback                                                             | sim   | {"ok": true, "status": "completed", "active_campaigns": 20, "candidates": 1, "issues": 0, "campaigns_paused_confirmed": 1, "alerts_delivered": 1, "audit_path": "/root/mgs-agent/data/ares/meta-ads/audit/guardrails/Eggbev-
```

## Pontos de atenção

- Alto risco: `housekeeping-bak-cleanup.sh`, `mgs-safety-backup.sh`, `eggbev-page-restriction-guardrail.sh`
...
- **Último log:** 2026-09-02T11:45:02-04:00 (12370097 bytes)
...
- **Último log:** 2026-09-02T11:42:45-04:00 (2081084 bytes)
...
- **Último log:** 2026-09-02T10:23:07-04:00 (90001 bytes)
...
- **Último log:** 2026-09-02T11:37:03-04:00 (947529 bytes)
...
- **Último log:** 2026-09-02T11:46:01-04:00 (12775838 bytes)
...
- **Último log:** 2026-09-01T11:54:01-04:00 (11145 bytes)
...
- **Último log:** 2026-09-02T11:43:01-04:00 (748714 bytes)
...
- **Último log:** 2026-09-02T05:00:13-04:00 (37261 bytes)
...
- **Último log:** 2026-09-02T08:37:55-04:00 (49666 bytes)
...
- **Último log:** 2026-09-02T11:45:01-04:00 (1802651 bytes)
...
- **Último log:** 2026-09-02T11:00:01-04:00 (68519 bytes)
...
- **Último log:** 2026-09-01T20:44:02-04:00 (22953 bytes)
...
- **Último log:** 2026-09-02T08:00:01-04:00 (11627 bytes)
...
- **Último log:** 2026-09-02T11:00:01-04:00 (157638 bytes)
...
- **Último log:** 2026-09-02T08:10:02-04:00 (4214 bytes)
...
- **Último log:** 2026-09-02T11:45:02-04:00 (624155 bytes)
...
- **Último log:** 2026-09-02T11:45:02-04:00 (3351845 bytes)
...
- **Último log:** 2026-09-02T08:07:02-04:00 (66868 bytes)
...
- **Último log:** 2026-09-02T03:41:01-04:00 (21323 bytes)
...
- **Último log:** 2026-09-02T08:54:10-04:00 (638946 bytes)
...
- **Último log:** 2026-09-02T09:16:02-04:00 (7235 bytes)
...
- **Último log:** 2026-09-02T11:45:03-04:00 (903046 bytes)
...
- **Último log:** 2026-09-02T11:45:03-04:00 (1467117 bytes)
...
- **Último log:** 2026-09-02T11:47:02-04:00 (2222142 bytes)
...
- **Último log:** 2026-09-02T06:55:34-04:00 (292394 bytes)
...
- **Último log:** 2026-09-02T11:39:01-04:00 (126324 bytes)
...
- **Último log:** 2026-09-02T11:19:02-04:00 (311031 bytes)
...
- **Último log:** 2026-09-02T08:00:14-04:00 (33497 bytes)
...
- **Último log:** 2026-09-02T11:47:01-04:00 (13763319 bytes)
...
- **Último log:** 2026-09-02T11:47:01-04:00 (5449809 bytes)
...
- **Último log:** 2026-09-02T08:05:15-04:00 (298634 bytes)
...
- **Último log:** 2026-09-02T11:46:09-04:00 (16246034 bytes)
...
- **Último log:** 2026-09-02T08:00:04-04:00 (12132 bytes)
...
- **Último log:** 2026-09-02T11:24:04-04:00 (80602 bytes)
...
- **Último log:** 2026-09-02T11:44:01-04:00 (1258201 bytes)
...
- **Último log:** 2026-09-02T11:47:02-04:00 (12554362 bytes)
...
- **Último log:** 2026-09-02T04:47:14-04:00 (6302 bytes)
...
- **Último log:** 2026-09-02T11:45:02-04:00 (634558 bytes)
...
- **Último log:** 2026-09-02T08:17:12-04:00 (18958 bytes)
...
- **Último log:** 2026-09-02T11:42:14-04:00 (144158 bytes)
...
- **Último log:** 2026-09-02T00:05:02-04:00 (1451 bytes)

### `ares-meta-account-activity-monitor.py`
- **Frequência:** `2-57/5 * * * *`
- **Owner:** Ares/Campaign Ops
- **Risco:** baixo: leitura Meta account-wide + estado local; Discord somente quando detectar alteração material de outra pessoa ou ferramenta externa
- **Função:** Monitora alterações materiais na conta Meta Creditoparaveiculo 13 e alerta somente ações de outra pessoa ou ferramenta externa; automações da Meta e writes do Ares identificados por audit ou fonte allowlisted ficam silenciosos.
...
- **Último log:** 2026-09-02T11:47:02-04:00 (34197 bytes)

### `eggbev-page-restriction-guardrail.sh`
- **Frequência:** `3-58/5 * * * *`
- **Owner:** Ares/Campaign Ops
- **Risco:** alto controlado: pode pausar campanhas após pre-read, política e GET/readback
- **Função:** Executa o guardrail Eggbev de restrição DTR a cada cinco minutos. A antiga etapa de campanha com gasto acima de US$2 e zero resultado de pixel está suspensa, removida do wrapper e sem write.
- **Comando:** `sleep 30 && /usr/bin/flock -n /var/lock/ares_eggbev_page_restriction_guardrail.lock /usr/bin/flock /root/mgs-agent/data/ares/meta-ads/state/Eggbev-US-CC-EN-BOT/roas-cycle.lock /root/.hermes/profiles/ares/scripts/eggbev-page-restriction-guardrail.sh >> /root/mgs-agent/logs/ares-eggbev-page-restriction-guardrail.log 2>&1`
- **Log:** `/root/mgs-agent/logs/ares-eggbev-page-restriction-guardrail.log`
- **Último log:** 2026-09-02T03:48:36-04:00 (568 bytes)
