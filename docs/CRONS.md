...
Gerado em: `2026-05-31T08:10:01-04:00`  
...
------------------- | ------------------------------ | -------------- | --------------------------------------- | ----- | -------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-31T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-31T07:56:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=c2dae3d
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-31 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-31T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-31T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas    | sim   | [2026-05-31T08:00:01-0400] OK total closed zombie sessions: 0 (grace=30min)
17 3 * * *          | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta arquivos .bak antigos      | sim   | [2026-05-31T03:17:02-04:00] housekeeping: === END — deletados 8 arquivos / .26 MB ===
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-31T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-31T12:00:01Z] cron-stale check: jobs=18 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-31T12:05:02.209461Z done posted=0 skipped=0 candidates=0 last_seen_id=1510442765648138482
```
...
- **Último log:** 2026-05-31T08:10:01-04:00 (27888 bytes)
...
- **Último log:** 2026-05-31T07:56:02-04:00 (6032 bytes)
...
- **Último log:** 2026-05-31T00:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-05-31T08:07:02-04:00 (4158 bytes)
...
- **Último log:** 2026-05-31T08:06:01-04:00 (34006 bytes)
...
- **Último log:** 2026-05-31T08:08:01-04:00 (3332 bytes)
...
- **Último log:** 2026-05-31T05:00:04-04:00 (578 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (7840 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (608 bytes)
...
- **Último log:** 2026-05-31T03:17:02-04:00 (1249 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (17120 bytes)
...
- **Último log:** 2026-05-31T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-05-31T08:05:02-04:00 (9604 bytes)
