...
Gerado em: `2026-08-12T08:10:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ---------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-12T08:10:01-04:00 synced zeus skills/growth/meta-utility-template-approval
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-12T07:57:01-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=cf1431cd
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                                | sim   | [2026-08-11T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-12 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-12T08:06:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                | sim   | Monitor GPT-5.6 OAuth enviado: calls=1008 sessions=38 input=5648457 output=594725 actual_usd=0.00 hypothetical_usd=52.03 config_ok=True billing_ok=False message_id=1536764638564323349
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-11T21:04:15-04:00] OK no_changes upstream=e9579a989 (last_notified=e9579a9)
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                    | sim   | [2026-08-12T08:00:02-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                 | sim   | [2026-08-12T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
44 20 * * 2,5            | housekeeping-bak-cleanup.sh                | Zeus/Infra        | alto: deleta backups antigos, preservando último por família                                         | sim   | [2026-08-11T20:44:03-04:00] housekeeping: === END (no-op) ===
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=42 generated_at=2026-08-11T08:10:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                    | sim   | [2026-08-12T12:00:02Z] cron-stale check: jobs=42 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                    | sim   | 2026-08-12T12:05:02.071293Z done posted=0 skipped=0 candidates=0 last_seen_id=1536897080805560420
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                          | sim   | [2026-08-12T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *               | mgs-safety-backup.sh                       | Zeus/Infra        | alto: cria snapshot e remove automaticamente safety backups além do mais recente                     | sim   | [2026-08-11T03:43:31-04:00] mgs-safety-backup: END OK archive=/root/mgs-agent/backups/safety/mgs-safety-20260811-034101.tar.gz size=3722.72MB manifest=/root/mgs-agent/backups/safety/mgs-safety-20260811-034101.manifest.tx
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-11T22:54:24-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *             | discord-archive-stale-agent-threads.py     | Zeus/Infra        | não classificado                                                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares"], "checked": 12, "stale": 0, "archived": 0, "skipped_recent": 12, "errors": 0}}
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                 | sim   | [2026-08-12T08:05:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-12T12:07:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1537016906270113833
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback           | sim   | {"status": "SYNC_OK", "target_date": "2026-08-11", "groups": 7, "source_rows": 7, "revenue_cents": 60037, "net_revenue_cents": 54035, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_date"
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                     | sim   | {"scanned": 312, "processed": 0, "status_counts": {"already_closed": 244, "already_quarantined": 68}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=211484 sent=325016 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=211484 sent=325016 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                  | sim   | 2026-08-12T12:09:01.877637Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                 | sim   | 2026-08-12T08:47:01.247812+00:00 status=ok profiles=3 errors=0 max_context_percent=43.35 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-12T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-12T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
10 23 * * *              | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"at_sp": "2026-08-12T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback | sim   | {"status":"SYNC_OK","started_at_et":"2026-08-11T08:17:02-04:00","completed_at_et":"2026-08-11T08:17:12-04:00","period_start":"2026-08-05","period_end":"2026-08-11","publishers":45,"api_rows":7124,"named_profiles":155,"da
```
...
- **Último log:** 2026-08-12T08:10:01-04:00 (6863796 bytes)
...
- **Último log:** 2026-08-12T07:57:01-04:00 (1456480 bytes)
...
- **Último log:** 2026-08-11T10:23:08-04:00 (58109 bytes)
...
- **Último log:** 2026-08-12T08:07:03-04:00 (682235 bytes)
...
- **Último log:** 2026-08-12T08:06:01-04:00 (9502536 bytes)
...
- **Último log:** 2026-08-11T11:54:01-04:00 (7270 bytes)
...
- **Último log:** 2026-08-12T08:08:01-04:00 (541756 bytes)
...
- **Último log:** 2026-08-12T05:00:12-04:00 (23898 bytes)
...
- **Último log:** 2026-08-11T21:04:15-04:00 (32483 bytes)
...
- **Último log:** 2026-08-12T08:00:02-04:00 (1305546 bytes)
...
- **Último log:** 2026-08-12T08:00:01-04:00 (64620 bytes)
...
- **Último log:** 2026-08-11T20:44:03-04:00 (20159 bytes)
...
- **Último log:** 2026-08-12T08:00:01-04:00 (8456 bytes)
...
- **Último log:** 2026-08-12T08:00:01-04:00 (114208 bytes)
...
- **Último log:** 2026-08-11T08:10:02-04:00 (2322 bytes)
...
- **Último log:** 2026-08-12T08:00:03-04:00 (451605 bytes)
...
- **Último log:** 2026-08-12T08:05:02-04:00 (2309777 bytes)
...
- **Último log:** 2026-08-12T08:07:02-04:00 (48472 bytes)
...
- **Último log:** 2026-08-12T03:41:01-04:00 (14835 bytes)
...
- **Último log:** 2026-08-11T22:54:24-04:00 (614744 bytes)
...
- **Último log:** 2026-08-11T09:16:02-04:00 (4881 bytes)
...
- **Último log:** 2026-08-12T08:00:04-04:00 (604911 bytes)
...
- **Último log:** 2026-08-12T08:05:03-04:00 (964885 bytes)
...
- **Último log:** 2026-08-12T08:07:01-04:00 (1432848 bytes)
...
- **Último log:** 2026-08-12T06:57:29-04:00 (192669 bytes)
...
- **Último log:** 2026-08-12T07:39:01-04:00 (76533 bytes)
...
- **Último log:** 2026-08-12T07:49:02-04:00 (183141 bytes)
...
- **Último log:** 2026-08-12T08:00:16-04:00 (21587 bytes)
...
- **Último log:** 2026-08-12T08:09:01-04:00 (7793792 bytes)
...
- **Último log:** 2026-08-12T08:09:01-04:00 (1673590 bytes)
...
- **Último log:** 2026-08-12T08:05:14-04:00 (168768 bytes)
...
- **Último log:** 2026-08-12T07:59:17-04:00 (8900219 bytes)
...
- **Último log:** 2026-08-12T07:24:03-04:00 (45056 bytes)
...
- **Último log:** 2026-08-12T08:04:02-04:00 (692478 bytes)
...
- **Último log:** 2026-08-12T08:09:02-04:00 (6375042 bytes)
...
- **Último log:** 2026-08-12T04:47:08-04:00 (3085 bytes)
...
- **Último log:** 2026-08-12T08:01:25-04:00 (155285 bytes)
...
- **Último log:** 2026-08-11T08:17:14-04:00 (2884 bytes)
