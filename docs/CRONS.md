...
Gerado em: `2026-06-08T08:10:01-04:00`
...
------------------- | ------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                             | sim   | 2026-06-08T08:05:02-04:00 synced hera skills/creative/creative-brief-handoff
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                             | sim   | [2026-06-08T07:56:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=2892762
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                             | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-08 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                             | sim   | 2026-06-08T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-08T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-08T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta backups antigos, preservando último por família      | sim   | [2026-06-08T03:17:03-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-08T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                 | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-08T12:00:01Z] cron-stale check: jobs=20 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-08T12:05:02.049961Z done posted=0 skipped=0 candidates=0 last_seen_id=1513341873874403388
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia       | sim   | [2026-06-08T08:07:01-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *          | mgs-safety-backup.sh           | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão              | sim   | [2026-06-08T03:41:01-04:00] mgs-safety-backup: SKIP: último backup ainda dentro do intervalo de 3 dias: /root/mgs-agent/backups/safety/mgs-safety-20260607-003036.tar.gz
```
...
- **Último log:** 2026-06-08T08:05:02-04:00 (27839 bytes)
...
- **Último log:** 2026-06-08T07:56:02-04:00 (6068 bytes)
...
- **Último log:** 2026-06-08T00:00:07-04:00 (0 bytes)
...
- **Último log:** 2026-06-08T08:07:02-04:00 (4158 bytes)
...
- **Último log:** 2026-06-08T08:06:01-04:00 (52822 bytes)
...
- **Último log:** 2026-06-08T08:08:01-04:00 (3332 bytes)
...
- **Último log:** 2026-06-08T05:00:06-04:00 (589 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (7840 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (4192 bytes)
...
- **Último log:** 2026-06-08T03:17:03-04:00 (283 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (18080 bytes)
...
- **Último log:** 2026-06-08T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-06-08T08:05:02-04:00 (9506 bytes)
...
- **Último log:** 2026-06-08T08:07:01-04:00 (292 bytes)
...
- **Último log:** 2026-06-08T03:41:01-04:00 (510 bytes)
