...
Gerado em: `2026-08-25T08:10:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ---------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-25T08:05:02-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-25T07:57:16-04:00] monitor-auto-push: Concluído. consecutive_failures=51 last_ok=a974d7bb
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                                | sim   | [2026-08-24T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (post_type=weekly). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 total=290 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-25 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                | sim   | 2026-08-25T08:06:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                | sim   | Monitor GPT-5.6 OAuth enviado: calls=491 sessions=13 input=3972354 output=248871 actual_usd=0.00 hypothetical_usd=33.03 config_ok=True billing_ok=False message_id=1541475684030091346
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                | sim   | [2026-08-24T20:37:03-04:00] OK notified upstream=41447a6d70 local=3eb5b8bc8f behind=13 new_since_last=33 days=0 feat=2 fix=9 breaking=0
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                    | sim   | [2026-08-25T08:00:02-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                 | sim   | [2026-08-25T08:00:02-0400] OK total closed zombie sessions: 0 (grace=180min)
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=42 generated_at=2026-08-24T08:10:01-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                    | sim   | [2026-08-25T12:00:02Z] cron-stale check: jobs=42 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                    | sim   | 2026-08-25T12:05:03.870069Z done posted=0 skipped=0 candidates=0 last_seen_id=1541651412356694026
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                          | sim   | [2026-08-25T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-24T22:54:26-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                 | sim   | [2026-08-25T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                     | sim   | [2026-08-25T12:07:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1541776582656663664
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                     | sim   | {"scanned": 348, "processed": 0, "status_counts": {"already_closed": 279, "already_quarantined": 69}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=144888 sent=391612 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                     | sim   | OK level=normal credits=144888 sent=391612 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                  | sim   | 2026-08-25T12:09:01.534668Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                 | sim   | 2026-08-25T08:47:01.950051+00:00 status=ok profiles=3 errors=0 max_context_percent=44.98 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"status": "error", "error": "TimeoutError:APIRequestContext.get: Timeout 30000ms exceeded.\nCall log:\n  - → GET https://api.jbfdigital.com.br/broadcast/Messenger?companies[]=digital-trust&companies[]=digital-trust-2&so
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"status": "error", "error": "TimeoutError:APIRequestContext.get: Timeout 30000ms exceeded.\nCall log:\n  - → GET https://api.jbfdigital.com.br/broadcast/Messenger?companies[]=digital-trust&companies[]=digital-trust-2&so
10 * * * *               | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                     | não   | {"status": "error", "error": "TimeoutError:APIRequestContext.get: Timeout 30000ms exceeded.\nCall log:\n  - → GET https://api.jbfdigital.com.br/broadcast/Messenger?companies[]=digital-trust&companies[]=digital-trust-2&so
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback | sim   | {"status":"SYNC_OK","started_at_et":"2026-08-24T08:17:01-04:00","completed_at_et":"2026-08-24T08:17:10-04:00","period_start":"2026-08-18","period_end":"2026-08-24","publishers":45,"api_rows":7285,"named_profiles":157,"da
```
...
- **Último log:** 2026-08-25T08:05:02-04:00 (10247693 bytes)
...
- **Último log:** 2026-08-25T07:57:16-04:00 (1797048 bytes)
...
- **Último log:** 2026-08-24T10:23:08-04:00 (76982 bytes)
...
- **Último log:** 2026-08-25T08:07:03-04:00 (845405 bytes)
...
- **Último log:** 2026-08-25T08:06:01-04:00 (11514764 bytes)
...
- **Último log:** 2026-08-24T11:54:02-04:00 (9660 bytes)
