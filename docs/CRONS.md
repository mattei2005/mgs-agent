...
Gerado em: `2026-09-06T08:32:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-06T08:30:02-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-06T08:27:52-04:00] monitor-auto-push: Concluído. consecutive_failures=75 last_ok=67d465312
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                                                            | sim   | [2026-09-05T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-06 08:22:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-06T08:31:02-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                                                            | sim   | Monitor GPT-5.6 OAuth enviado: calls=2008 sessions=41 input=16813229 output=1112358 actual_usd=0.00 hypothetical_usd=141.05 config_ok=False billing_ok=False message_id=1545824335871348839
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-05T20:37:07-04:00] OK notified upstream=245e48008f local=a61bd91813 release=v2026.8.31 stable_update=false stable_pending=0 main_post_release=5340 new_since_last=7 feat=68 fix=693 breaking=0
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                                | sim   | [2026-09-06T08:30:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                             | sim   | [2026-09-06T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
32 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                                                                | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=46 generated_at=2026-09-05T08:32:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                                | sim   | [2026-09-06T12:30:01Z] cron-stale check: jobs=45 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                                | sim   | 2026-09-06T12:30:01.778039Z done posted=0 skipped=0 candidates=0 last_seen_id=1545955977323352066
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                      | sim   | [2026-09-06T08:07:01-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-05T22:54:01-04:00] monitor-honcho-health: BILLING_BLOCKED: external checks suppressed; manual top-up required; recheck with HONCHO_BILLING_RECHECK=1
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                             | sim   | [2026-09-06T08:30:02-0400] monitor-vps-health: DONE status=alert issues=1 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                                 | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-06T12:27:01Z] alerts-infra-failed-alert-resolver: DONE candidates=2 handled=0 skipped=2 last_seen_id=1546134608507052073
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                                                 | sim   | "op_errors": [],
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                                                         | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.16% account:read_write=0.19%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                       | sim   | {"status": "SYNC_OK", "target_date": "2026-09-05", "groups": 13, "source_rows": 13, "revenue_cents": 440447, "net_revenue_cents": 396402, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                                 | sim   | {"scanned": 462, "processed": 0, "status_counts": {"already_closed": 364, "already_quarantined": 98}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=232281 sent=679219 notification=none message_id=none
3-58/5 13,14 * * 5       | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=232281 sent=679219 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                              | sim   | 2026-09-06T12:31:01.954944Z watchdog done dry_run=0 healthy=49 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                             | sim   | 2026-09-06T08:47:01.933060+00:00 status=ok profiles=3 errors=0 max_context_percent=11.55 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                             | sim   | {"status":"SYNC_FAILED","started_at_et":"2026-09-06T08:17:01-04:00","completed_at_et":"2026-09-06T08:17:09-04:00","error":"RuntimeError: target Sheet headers changed","alerted":true}
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada ao vivo; estado local só faz cursor/dedupe, sem replay; envia apenas notificações novas/reabertas | sim   | {"ok": true, "mode": "noop", "last_seen_id": 682202, "alerts_seen": 293, "new_alerts": 0, "refreshed_incidents": 0, "daily": {"date": "2026-09-06", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_s
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | médio: exclusão limitada de mensagens Discord anteriores ao dia anterior, com readback                                           | sim   | {"ok": true, "mode": "retention-apply", "cutoff": "2026-09-05T00:00:00-04:00", "scanned": 12, "eligible": 9, "would_delete": 0, "deleted": 9, "already_missing": 0, "remaining": 0, "message_ids": ["1545587324237250591", "
...
- **Último log:** 2026-09-06T08:30:02-04:00 (13376474 bytes)
...
- **Último log:** 2026-09-06T08:27:52-04:00 (2224244 bytes)
...
- **Último log:** 2026-09-05T10:23:08-04:00 (94300 bytes)
...
- **Último log:** 2026-09-06T08:22:03-04:00 (995759 bytes)
...
- **Último log:** 2026-09-06T08:31:02-04:00 (13373214 bytes)
...
- **Último log:** 2026-09-05T11:54:01-04:00 (11897 bytes)
...
- **Último log:** 2026-09-06T08:28:01-04:00 (786522 bytes)
...
- **Último log:** 2026-09-06T05:00:12-04:00 (39585 bytes)
...
- **Último log:** 2026-09-05T20:37:07-04:00 (52772 bytes)
...
- **Último log:** 2026-09-06T08:30:01-04:00 (1893546 bytes)
...
- **Último log:** 2026-09-06T08:00:01-04:00 (65781 bytes)
...
- **Último log:** 2026-09-06T08:00:01-04:00 (12231 bytes)
...
- **Último log:** 2026-09-06T08:00:01-04:00 (165636 bytes)
...
- **Último log:** 2026-09-05T08:32:02-04:00 (4472 bytes)
...
- **Último log:** 2026-09-06T08:30:02-04:00 (655690 bytes)
...
- **Último log:** 2026-09-06T08:30:01-04:00 (3542281 bytes)
...
- **Último log:** 2026-09-06T08:07:01-04:00 (70372 bytes)
...
- **Último log:** 2026-09-06T03:41:01-04:00 (22641 bytes)
...
- **Último log:** 2026-09-05T22:54:01-04:00 (641977 bytes)
...
- **Último log:** 2026-09-05T09:16:01-04:00 (7556 bytes)
...
- **Último log:** 2026-09-06T08:30:02-04:00 (957583 bytes)
...
- **Último log:** 2026-09-06T08:30:02-04:00 (1559989 bytes)
...
- **Último log:** 2026-09-06T08:27:01-04:00 (2367698 bytes)
...
- **Último log:** 2026-09-06T06:53:32-04:00 (311524 bytes)
...
- **Último log:** 2026-09-06T07:39:01-04:00 (135340 bytes)
...
- **Último log:** 2026-09-06T08:19:02-04:00 (334467 bytes)
...
- **Último log:** 2026-09-06T08:00:12-04:00 (35733 bytes)
...
- **Último log:** 2026-09-06T08:31:02-04:00 (14781165 bytes)
...
- **Último log:** 2026-09-06T08:32:01-04:00 (6140828 bytes)
...
- **Último log:** 2026-09-06T08:05:14-04:00 (323655 bytes)
...
- **Último log:** 2026-09-06T08:29:15-04:00 (17631790 bytes)
...
- **Último log:** 2026-09-06T08:00:04-04:00 (20220 bytes)
...
- **Último log:** 2026-09-06T08:24:03-04:00 (87721 bytes)
...
- **Último log:** 2026-09-06T08:24:02-04:00 (1361431 bytes)
...
- **Último log:** 2026-09-06T08:31:02-04:00 (13683448 bytes)
...
- **Último log:** 2026-09-06T04:47:16-04:00 (6914 bytes)
...
- **Último log:** 2026-09-06T08:30:02-04:00 (734361 bytes)
...
- **Último log:** 2026-09-06T08:17:09-04:00 (21393 bytes)
...
- **Último log:** 2026-09-06T08:27:12-04:00 (248777 bytes)
...
- **Último log:** 2026-09-06T00:05:07-04:00 (2932 bytes)
