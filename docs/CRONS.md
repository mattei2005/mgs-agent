...
Gerado em: `2026-06-12T01:14:32-04:00`
...
------------------- | ------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | -------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                             | sim   | 2026-06-12T01:10:01-04:00 synced hera skills/creative/creative-brief-handoff
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                             | sim   | [2026-06-12T01:11:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=2405a464
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                             | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-12 01:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                             | sim   | 2026-06-12T01:11:02-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-12T01:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-12T01:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-12T05:00:01Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-12T05:00:01Z] cron-stale check: jobs=20 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-12T05:10:01.804471Z done posted=0 skipped=0 candidates=0 last_seen_id=1514791416424038442
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia       | sim   | (sem log útil ainda)
41 3 * * *          | mgs-safety-backup.sh           | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão              | sim   | (sem log útil ainda)
```
...
- **Último log:** 2026-06-12T01:10:01-04:00 (4350 bytes)
...
- **Último log:** 2026-06-12T01:11:02-04:00 (955 bytes)
...
- **Último log:** 2026-06-12T01:07:02-04:00 (630 bytes)
...
- **Último log:** 2026-06-12T01:11:02-04:00 (6468 bytes)
...
- **Último log:** 2026-06-12T01:13:01-04:00 (510 bytes)
...
- **Último log:** 2026-06-12T01:00:01-04:00 (1225 bytes)
...
- **Último log:** 2026-06-12T01:00:01-04:00 (999 bytes)
...
- **Último log:** 2026-06-12T01:00:01-04:00 (172 bytes)
...
- **Último log:** 2026-06-12T01:00:01-04:00 (2825 bytes)
...
- **Último log:** 2026-06-12T01:00:01-04:00 (425 bytes)
...
- **Último log:** 2026-06-12T01:10:01-04:00 (1470 bytes)
