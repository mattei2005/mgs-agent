...
Gerado em: `2026-07-03T14:23:57-04:00`
Fonte: `root crontab + script/log stat, read-only`
Total MGS ativo no root crontab: **25**
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-03T14:20:01-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-03T14:11:04-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=fa472c68
23 10 * * *         | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo | baixo                                                                | sim   | [2026-07-03T10:23:02-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-03 14:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-03T14:21:01-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                                | sim   | Zeus 219 Atena 0 Ares 0 Hera 15
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                                | sim   | [2026-07-03T08:37:03-04:00] OK notified upstream=22c5048d9 local=efd87a154 behind=573 days=2 feat=47 fix=351 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-03T14:15:02-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-03T14:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família         | sim   | [2026-07-03T03:17:05-04:00] housekeeping: === END — deletados 1 arquivos / 0.01 MB ===
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-03T18:15:02Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py                      | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                    | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=25 generated_at=2026-07-03T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-03T18:15:02Z] cron-stale check: jobs=26 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-03T18:20:01.591251Z done posted=0 skipped=0 candidates=0 last_seen_id=1522582764111790171
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-03T14:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-03T14:15:56-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra     | não classificado                                                     | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares", "hera"], "checked": 19, "stale": 1, "archived": 1, "skipped_recent": 18, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-03T14:20:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
0 8,16 * * *        | monitor-sb-restricted-pages.sh             | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-03T08:00:15-04:00] monitor-sb-restricted-pages: OK
```
...
- **Último log:** 2026-07-03T14:20:01-04:00 (1642111 bytes)
...
- **Último log:** 2026-07-03T14:11:04-04:00 (543805 bytes)
...
- **Último log:** 2026-07-03T10:23:02-04:00 (8395 bytes)
...
- **Último log:** 2026-07-03T14:22:02-04:00 (188076 bytes)
...
- **Último log:** 2026-07-03T14:21:01-04:00 (2945419 bytes)
...
- **Último log:** 2026-07-03T12:47:02-04:00 (1475 bytes)
...
- **Último log:** 2026-07-03T14:23:01-04:00 (152762 bytes)
...
- **Último log:** 2026-07-03T05:00:09-04:00 (14158 bytes)
...
- **Último log:** 2026-07-03T08:37:03-04:00 (8113 bytes)
...
- **Último log:** 2026-07-03T14:15:02-04:00 (371116 bytes)
...
- **Último log:** 2026-07-03T14:00:01-04:00 (61777 bytes)
...
- **Último log:** 2026-07-03T03:17:05-04:00 (12236 bytes)
...
- **Último log:** 2026-07-03T08:00:01-04:00 (2416 bytes)
...
- **Último log:** 2026-07-03T14:00:01-04:00 (32250 bytes)
...
- **Último log:** 2026-07-03T14:15:02-04:00 (894050 bytes)
...
- **Último log:** 2026-07-03T08:10:01-04:00 (1892 bytes)
...
- **Último log:** 2026-07-03T14:15:02-04:00 (127330 bytes)
...
- **Último log:** 2026-07-03T14:20:01-04:00 (440314 bytes)
...
- **Último log:** 2026-07-03T14:07:02-04:00 (13724 bytes)
...
- **Último log:** 2026-07-03T03:41:01-04:00 (3165 bytes)
...
- **Último log:** 2026-07-03T14:15:56-04:00 (369069 bytes)
...
- **Último log:** 2026-07-03T14:08:01-04:00 (708 bytes)
...
- **Último log:** 2026-07-03T14:15:04-04:00 (39525 bytes)
...
- **Último log:** 2026-07-03T14:20:02-04:00 (15044 bytes)
...
- **Último log:** 2026-07-03T08:00:15-04:00 (3203 bytes)
