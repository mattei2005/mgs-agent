...
Gerado em: `2026-06-12T00:16:13-04:00`
...
------------------- | ------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | -------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                             | sim   | 2026-06-12T00:15:02-04:00 synced hera skills/creative/creative-brief-handoff
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                             | sim   | [2026-06-12T00:11:01-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=n/a
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                             | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-12 00:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                             | sim   | 2026-06-12T00:16:13-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-12T00:15:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-12T00:00:01-0400] DONE total closed zombie sessions: 1 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-12T04:15:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                 | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-12T04:15:01Z] cron-stale check: jobs=19 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-12T04:15:02.279577Z done posted=0 skipped=0 candidates=0 last_seen_id=1514791416424038442
...
- **Último log:** 2026-06-12T00:15:02-04:00 (1193 bytes)
...
- **Último log:** 2026-06-12T00:11:01-04:00 (187 bytes)
...
- **Último log:** 2026-06-12T00:07:02-04:00 (126 bytes)
...
- **Último log:** 2026-06-12T00:16:13-04:00 (539 bytes)
...
- **Último log:** 2026-06-12T00:13:01-04:00 (102 bytes)
...
- **Último log:** 2026-06-12T00:15:01-04:00 (490 bytes)
...
- **Último log:** 2026-06-12T00:00:01-04:00 (517 bytes)
...
- **Último log:** 2026-06-12T00:00:01-04:00 (86 bytes)
...
- **Último log:** 2026-06-12T00:15:01-04:00 (1130 bytes)
...
- **Último log:** 2026-06-12T00:15:01-04:00 (170 bytes)
...
- **Último log:** 2026-06-12T00:15:02-04:00 (392 bytes)
