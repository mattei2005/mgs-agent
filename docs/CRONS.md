...
Gerado em: `2026-08-29T08:10:02-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-08-29T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-08-29T07:57:26-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=4e1c607e
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                         | sim   | [2026-08-29 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                         | sim   | 2026-08-29T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                             | sim   | [2026-08-29T08:00:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                          | sim   | [2026-08-29T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                             | sim   | [2026-08-29T12:00:01Z] cron-stale check: jobs=45 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                             | sim   | 2026-08-29T12:05:02.070864Z done posted=0 skipped=0 candidates=0 last_seen_id=1543057695362388113
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                   | sim   | [2026-08-29T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                          | sim   | [2026-08-29T08:05:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                              | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                              | sim   | [2026-08-29T12:07:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1543227342950895708
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                                              | sim   | "errors": []
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                                                      | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.00% account:read_write=0.10%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                    | sim   | {"status": "SYNC_OK", "target_date": "2026-08-28", "groups": 13, "source_rows": 13, "revenue_cents": 334190, "net_revenue_cents": 300770, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
0 8,14,20 * * *          | refresh-sb-restricted-history-sheet.py     | Zeus/Infra        | não classificado                                                                                                              | sim   | {"coverage_start": "2026-07-15T14:38:01-04:00", "history_rows": 575, "mode": "apply", "ok": true, "sheet_update": {"history_index": 2, "readback_ok": true, "rows_historico_restricoes": 575, "tab": "Histórico Restrições",
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                              | sim   | OK level=normal credits=84241 sent=452259 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                              | sim   | OK level=normal credits=84241 sent=452259 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                           | sim   | 2026-08-29T12:09:01.583583Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                          | sim   | 2026-08-29T08:47:01.427940+00:00 status=ok profiles=3 errors=0 max_context_percent=61.02 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                                              | não   | {"at_sp": "2026-08-29T09:00:30-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68fb92a6-c758-ed62-b962-f721932e1d43", "template": "Financetopfeed - US-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "U
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                                              | não   | {"at_sp": "2026-08-29T09:00:30-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68fb92a6-c758-ed62-b962-f721932e1d43", "template": "Financetopfeed - US-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "U
10 * * * *               | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                                                              | não   | {"at_sp": "2026-08-29T09:00:30-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68fb92a6-c758-ed62-b962-f721932e1d43", "template": "Financetopfeed - US-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "U
...
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada, republica incidentes ativos uma vez por dia e envia novos/reabertos sem repetição intradiária | sim   | {"ok": true, "mode": "noop", "last_seen_id": 676207, "alerts_seen": 332, "new_alerts": 0, "daily": {"date": "2026-08-29", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_send": 0}}
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech