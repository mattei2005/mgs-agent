...
Gerado em: `2026-05-30T07:27:45-04:00`  
...
------------------- | ------------------------------ | -------------- | --------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-30T07:25:01-04:00 synced ares skills/growth
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-30T07:26:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=17a889c
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-30 07:22:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-30T07:26:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-30T07:15:01-0400] Nothing to process. Exit.
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-30T11:15:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-30T11:15:01Z] cron-stale check: jobs=18 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-30T11:25:01.590655Z done posted=0 skipped=0 candidates=0 last_seen_id=1510231397527326761
```
...
- **Último log:** 2026-05-30T07:25:01-04:00 (25543 bytes)
...
- **Último log:** 2026-05-30T07:26:02-04:00 (5730 bytes)
...
- **Último log:** 2026-05-30T07:22:02-04:00 (3780 bytes)
...
- **Último log:** 2026-05-30T07:26:01-04:00 (31230 bytes)
...
- **Último log:** 2026-05-30T07:23:01-04:00 (3026 bytes)
...
- **Último log:** 2026-05-30T07:15:01-04:00 (9576 bytes)
...
- **Último log:** 2026-05-30T07:00:01-04:00 (517 bytes)
...
- **Último log:** 2026-05-30T07:00:01-04:00 (602 bytes)
...
- **Último log:** 2026-05-30T07:15:01-04:00 (15515 bytes)
...
- **Último log:** 2026-05-30T07:15:01-04:00 (2465 bytes)
...
- **Último log:** 2026-05-30T07:25:01-04:00 (8722 bytes)
