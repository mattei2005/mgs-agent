...
Gerado em: `2026-05-26T08:10:01-04:00`  
...
------------ | ------------------------------ | -------------- | --------------------------------------- | ----- | -------------------------------------------------------------------------------------------------
*/5 * * * *  | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-26T08:10:01-04:00 synced zeus skills/ops
*/15 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-26T07:45:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=cc11a85
0 10 * * *   | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
*/15 * * * * | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-26 08:00:01] ERRO: Não foi possível obter WEBHOOK_URL do 1Password. Abortando.
*/5 * * * *  | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-26T08:05:01-04:00 [monitor-service-restarts] ERROR: webhook_url vazio (1P indisponível?)
...
0 8 * * *    | monitor-hermes-updates.sh      | Zeus/Infra     | baixo                                   | sim   | [2026-05-26T08:00:01-04:00] START monitor-hermes-updates
*/15 * * * * | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-26T08:00:01-0400] Mode: ALL pending
0 * * * *    | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas    | sim   | (sem log útil ainda)
0 3 * * *    | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta arquivos .bak antigos      | sim   | [2026-05-26T03:00:02-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * * | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-26T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *   | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | (sem log útil ainda)
*/15 * * * * | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-26T12:00:01Z] cron-stale check: jobs=18 problems=1 resolved=0 alerts_sent=0
*/5 * * * *  | hermes-news-explainer.py       | Zeus/Infra     | não classificado                        | sim   | 2026-05-26T12:05:01.456770Z done posted=0 skipped=0 candidates=0 last_seen_id=1508598820718514196
```
...
- **Último log:** 2026-05-26T08:10:01-04:00 (15375 bytes)
...
- **Último log:** 2026-05-26T07:45:02-04:00 (6028 bytes)
...
- **Último log:** 2026-05-26T00:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-05-26T08:00:02-04:00 (4122 bytes)
...
- **Último log:** 2026-05-26T08:05:01-04:00 (33508 bytes)
...
- **Último log:** 2026-05-26T07:55:02-04:00 (3264 bytes)
...
- **Último log:** 2026-05-26T05:00:03-04:00 (568 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (57 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (4512 bytes)
...
- **Último log:** 2026-05-25T19:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-05-26T03:00:02-04:00 (240 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (12960 bytes)
...
- **Último log:** 2026-05-26T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-05-26T08:05:01-04:00 (9604 bytes)
