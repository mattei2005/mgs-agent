...
Gerado em: `2026-08-06T08:10:01-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ------------------------------------------------------------------------------------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                      | sim   | 2026-08-06T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-06T07:56:55-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=583189fc
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                      | sim   | [2026-08-05T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-06 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                      | sim   | 2026-08-06T08:06:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                      | sim   | Monitor GPT-5.6 OAuth enviado: calls=104 sessions=3 input=399131 output=41237 actual_usd=0.00 hypothetical_usd=3.66 config_ok=True billing_ok=False message_id=1534590314893938779
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-05T20:37:01-04:00] OK no_changes upstream=ed3c39108b (last_notified=ed3c391)
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                          | sim   | [2026-08-06T08:00:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                       | sim   | [2026-08-06T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
44 20 * * 2,5            | housekeeping-bak-cleanup.sh                | Zeus/Infra        | alto: deleta backups antigos, preservando último por família                               | sim   | [2026-08-04T20:44:09-04:00] housekeeping: === END (no-op) ===
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                          | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=41 generated_at=2026-08-05T08:10:02-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                          | sim   | [2026-08-06T12:00:01Z] cron-stale check: jobs=41 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                          | sim   | 2026-08-06T12:05:02.370664Z done posted=0 skipped=0 candidates=0 last_seen_id=1533906403687923885
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                | sim   | [2026-08-06T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *               | mgs-safety-backup.sh                       | Zeus/Infra        | alto: cria snapshot e remove automaticamente safety backups além dos 2 mais recentes       | sim   | [2026-08-03T03:43:21-04:00] mgs-safety-backup: END OK archive=/root/mgs-agent/backups/safety/mgs-safety-20260803-034101.tar.gz size=3478.46MB manifest=/root/mgs-agent/backups/safety/mgs-safety-20260803-034101.manifest.tx
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                           | sim   | [2026-08-05T22:54:32-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                       | sim   | [2026-08-06T08:05:03-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                           | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                           | sim   | [2026-08-06T12:07:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1534797272422813838
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback | sim   | {"status": "SYNC_OK", "target_date": "2026-08-05", "groups": 7, "source_rows": 7, "revenue_cents": 103479, "net_revenue_cents": 93131, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_date
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                           | sim   | {"scanned": 253, "processed": 0, "status_counts": {"already_closed": 199, "already_quarantined": 54}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                           | sim   | OK level=normal credits=235449 sent=301051 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                           | sim   | OK level=normal credits=235449 sent=301051 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã        | sim   | 2026-08-06T12:09:01.240908Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas       | sim   | 2026-08-06T08:47:01.630562+00:00 status=ok profiles=3 errors=0 max_context_percent=50.24 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-06T09:00:02-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-06T09:00:02-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
10 23 * * *              | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-06T09:00:02-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "68925ccb-335a-35e8-5471-5a52003c6560", "template": "Zuout - US-CC-ES/ES-ZW - AV - g002-d Gustavo", "vertical": "US-C
```

## Pontos de atenção

- Alto risco: `housekeeping-bak-cleanup.sh`, `mgs-safety-backup.sh`
- Médio risco: `infra-discovery.sh`, `cleanup-zombie-sessions.sh`, `sync-sb-sms-revenue-daily.sh`, `monitor-hermes-memory-capacity.py`
...
- **Último log:** 2026-08-06T08:10:01-04:00 (5302505 bytes)
...
- **Último log:** 2026-08-06T07:56:55-04:00 (1322564 bytes)
...
- **Último log:** 2026-08-05T10:23:08-04:00 (49389 bytes)
...
- **Último log:** 2026-08-06T08:07:03-04:00 (606857 bytes)
...
- **Último log:** 2026-08-06T08:06:01-04:00 (8573820 bytes)
