...
Gerado em: `2026-07-05T08:10:01-04:00`
...
------------------- | ------------------------------------------ | -------------- | -------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                                | sim   | 2026-07-05T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                                | sim   | [2026-07-05T07:56:12-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=21aa4f5b
...
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                                | sim   | [2026-07-05 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                                | sim   | 2026-07-05T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                    | sim   | [2026-07-05T08:00:02-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                                 | sim   | [2026-07-05T08:00:02-0400] DONE total closed zombie sessions: 1 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                               | sim   | [2026-07-05T12:00:02Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                    | sim   | [2026-07-05T12:00:02Z] cron-stale check: jobs=27 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática    | sim   | 2026-07-05T12:05:01.844604Z done posted=0 skipped=0 candidates=0 last_seen_id=1523126361915523215
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia          | sim   | [2026-07-05T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-05T08:01:06-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra     | baixo: read-only + alerta Discord em anomalia da VPS                 | sim   | [2026-07-05T08:05:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
0 8,16 * * *        | monitor-sb-restricted-pages.sh             | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-05T08:00:15-04:00] monitor-sb-restricted-pages: OK
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra     | não classificado                                                     | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra     | não classificado                                                     | sim   | [2026-07-05T12:07:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1523226190750548020
```
...
- **Último log:** 2026-07-05T08:10:01-04:00 (1828121 bytes)
...
- **Último log:** 2026-07-05T07:56:12-04:00 (587094 bytes)
...
- **Último log:** 2026-07-05T08:07:03-04:00 (209118 bytes)
...
- **Último log:** 2026-07-05T08:06:01-04:00 (3277751 bytes)
...
- **Último log:** 2026-07-05T08:08:01-04:00 (169762 bytes)
...
- **Último log:** 2026-07-05T05:00:10-04:00 (15928 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (412031 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (83480 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (2718 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (35862 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (1001765 bytes)
...
- **Último log:** 2026-07-05T08:00:02-04:00 (141525 bytes)
...
- **Último log:** 2026-07-05T08:05:01-04:00 (489412 bytes)
...
- **Último log:** 2026-07-05T08:07:02-04:00 (15184 bytes)
...
- **Último log:** 2026-07-05T03:41:01-04:00 (3505 bytes)
...
- **Último log:** 2026-07-05T08:01:06-04:00 (417975 bytes)
...
- **Último log:** 2026-07-05T08:00:04-04:00 (65408 bytes)
...
- **Último log:** 2026-07-05T08:05:02-04:00 (56904 bytes)
...
- **Último log:** 2026-07-05T08:00:15-04:00 (4776 bytes)
...
- **Último log:** 2026-07-05T08:07:02-04:00 (10270 bytes)
