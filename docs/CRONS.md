...
Gerado em: `2026-06-07T08:10:01-04:00`  
...
------------------- | ------------------------------ | -------------- | ------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                        | sim   | 2026-06-07T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                        | sim   | [2026-06-07T07:56:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=74def0a
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                        | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                        | sim   | [2026-06-07 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                        | sim   | 2026-06-07T08:06:01-04:00 [monitor-service-restarts] OK
...
37 8,14,20 * * *    | monitor-hermes-updates.sh      | Zeus/Infra     | baixo                                                        | sim   | [2026-06-07T00:49:06-04:00] OK no_changes upstream=210f4e706 (last_notified=210f4e7)
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                            | sim   | [2026-06-07T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                         | sim   | [2026-06-07T08:00:01-0400] DONE total closed zombie sessions: 1 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                       | sim   | [2026-06-07T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                            | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=20 generated_at=2026-06-07T00:32:33-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                            | sim   | [2026-06-07T12:00:01Z] cron-stale check: jobs=20 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | não classificado                                             | sim   | 2026-06-07T12:05:02.108610Z done posted=0 skipped=0 candidates=0 last_seen_id=1513101518516129826
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | não classificado                                             | sim   | [2026-06-07T08:07:01-04:00] monitor-webshare-status: OK completed mode=normal
...
- **Último log:** 2026-06-07T08:10:01-04:00 (27888 bytes)
...
- **Último log:** 2026-06-07T07:56:02-04:00 (7065 bytes)
...
- **Último log:** 2026-06-07T08:07:02-04:00 (4158 bytes)
...
- **Último log:** 2026-06-07T08:06:01-04:00 (51286 bytes)
...
- **Último log:** 2026-06-07T08:08:01-04:00 (3332 bytes)
...
- **Último log:** 2026-06-07T05:00:05-04:00 (2945 bytes)
...
- **Último log:** 2026-06-07T00:49:06-04:00 (460 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (7840 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (7385 bytes)
...
- **Último log:** 2026-06-07T03:17:01-04:00 (283 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (18080 bytes)
...
- **Último log:** 2026-06-07T00:32:33-04:00 (172 bytes)
...
- **Último log:** 2026-06-07T08:00:01-04:00 (2720 bytes)
...
- **Último log:** 2026-06-07T08:05:02-04:00 (9506 bytes)
...
- **Último log:** 2026-06-07T08:07:01-04:00 (292 bytes)
...
- **Último log:** 2026-06-07T03:41:01-04:00 (340 bytes)
