...
Gerado em: `2026-09-11T20:39:55-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-11T20:35:01-04:00 synced ares skills/ops/log-monitor-discord-alert
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-11T20:28:07-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=90c5efdb3
...
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                                                            | sim   | [2026-09-11 20:37:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                                                            | sim   | 2026-09-11T20:36:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                                                                | sim   | [2026-09-11T20:30:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                                                             | sim   | [2026-09-11T20:00:01-0400] DONE total closed zombie sessions: 1 (grace=180min)
44 20 * * 2,5            | housekeeping-bak-cleanup.sh                | Zeus/Infra        | alto: deleta backups antigos, preservando último por família                                                                     | sim   | [2026-09-08T20:44:02-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                                                                | sim   | [2026-09-12T00:30:02Z] cron-stale check: jobs=45 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                                                                | sim   | 2026-09-12T00:35:01.650819Z done posted=0 skipped=0 candidates=0 last_seen_id=1548040535892173001
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                                                      | sim   | [2026-09-11T20:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *               | mgs-safety-backup.sh                       | Zeus/Infra        | alto: cria snapshot e remove automaticamente safety backups além do mais recente                                                 | sim   | [2026-09-08T03:42:06-04:00] mgs-safety-backup: END OK archive=/root/mgs-agent/backups/safety/mgs-safety-20260908-034101.tar.gz size=1342.99MB manifest=/root/mgs-agent/backups/safety/mgs-safety-20260908-034101.manifest.tx
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-11T18:54:01-04:00] monitor-honcho-health: BILLING_BLOCKED: external checks suppressed; manual top-up required; recheck with HONCHO_BILLING_RECHECK=1
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                                                             | sim   | [2026-09-11T20:35:02-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                                                                 | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                                                                 | sim   | [2026-09-12T00:37:01Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1548060457011781774
20 6 * * *               | dtr-sb-daily-match-audit.sh                | Zeus/Infra        | não classificado                                                                                                                 | sim   | "op_errors": [],
39 * * * *               | monitor-op-rate-limit.py                   | Zeus/Infra        | baixo: consulta read-only + alerta Discord por transição                                                                         | sim   | OK level=normal transition_sent=false token:write=0.00% token:read=0.00% account:read_write=0.06%
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback                                       | sim   | {"status": "SYNC_OK", "target_date": "2026-09-10", "groups": 13, "source_rows": 13, "revenue_cents": 282495, "net_revenue_cents": 254245, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_d
...
* * * * *                | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                                                                 | sim   | {"scanned": 527, "processed": 0, "status_counts": {"already_closed": 398, "already_quarantined": 129}, "log_rotated": false}
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=77465 sent=834035 notification=none message_id=none
3-58/5 13,14 * * 5       | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                                                                 | sim   | OK level=normal credits=77465 sent=834035 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã                                              | sim   | 2026-09-12T00:39:01.827465Z watchdog done dry_run=0 healthy=55 waiting=1 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas                                             | sim   | 2026-09-11T08:47:01.575753+00:00 status=ok profiles=3 errors=0 max_context_percent=15.90 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
...
17 8 * * *               | sync-sb-messenger-revenue-sheet.py         | Zeus/Revenue Tech | médio: lê SB autenticada e substitui a coluna C da planilha com backup, canário, rollback e readback                             | sim   | {"status":"SYNC_OK","started_at_et":"2026-09-11T08:17:01-04:00","completed_at_et":"2026-09-11T08:17:09-04:00","period_start":"2026-09-05","period_end":"2026-09-11","publishers":45,"api_rows":7212,"named_profiles":145,"da
12,27,42,57 * * * *      | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech | baixo/médio: lê SB autenticada ao vivo; estado local só faz cursor/dedupe, sem replay; envia apenas notificações novas/reabertas | sim   | {"ok": true, "mode": "noop", "last_seen_id": 687639, "alerts_seen": 301, "new_alerts": 0, "refreshed_incidents": 0, "daily": {"date": "2026-09-11", "rollover": false, "active": 0, "resolved": 0, "daily_sent": 0, "would_s
5 0 * * *                | monitor-sb-messenger-token-invalid.py      | Zeus/Revenue Tech