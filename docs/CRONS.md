...
Gerado em: `2026-06-17T08:10:01-04:00`
...
------------------- | ------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                  | Zeus/Infra     | baixo                                                             | sim   | 2026-06-17T08:05:01-04:00 synced hera skills/creative/creative-brief-handoff
11,26,41,56 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                                             | sim   | [2026-06-17T07:56:01-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=216b7142
23 10 * * *         | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                                             | sim   | (sem log útil ainda)
7,22,37,52 * * * *  | check-pending-reports.sh       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-17 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                                             | sim   | 2026-06-17T08:06:01-04:00 [monitor-service-restarts] OK
...
*/15 * * * *        | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-17T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh     | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-17T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh    | Zeus/Infra     | alto: deleta backups antigos, preservando último por família      | sim   | [2026-06-17T03:17:02-04:00] housekeeping: === END (no-op) ===
...
*/15 * * * *        | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-17T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                 | sim   | (sem log útil ainda)
*/15 * * * *        | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-17T12:00:01Z] cron-stale check: jobs=20 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py       | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-17T12:05:01.271047Z done posted=0 skipped=0 candidates=0 last_seen_id=1516603370150821989
7 8,14,20 * * *     | monitor-webshare-status.sh     | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia       | sim   | [2026-06-17T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *          | mgs-safety-backup.sh           | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão              | sim   | [2026-06-17T03:41:01-04:00] mgs-safety-backup: SKIP: último backup ainda dentro do intervalo de 3 dias: /root/mgs-agent/backups/safety/mgs-safety-20260616-034102.tar.gz
```
...
- **Último log:** 2026-06-17T08:05:01-04:00 (28126 bytes)
...
- **Último log:** 2026-06-17T07:56:01-04:00 (11552 bytes)
...
- **Último log:** 2026-06-17T00:00:01-04:00 (0 bytes)
...
- **Último log:** 2026-06-17T08:07:02-04:00 (4158 bytes)
...
- **Último log:** 2026-06-17T08:06:01-04:00 (64092 bytes)
...
- **Último log:** 2026-06-17T08:08:01-04:00 (3332 bytes)
...
- **Último log:** 2026-06-17T05:00:06-04:00 (589 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (8085 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (4843 bytes)
...
- **Último log:** 2026-06-17T03:17:02-04:00 (285 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (151 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (774 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (18645 bytes)
...
- **Último log:** 2026-06-17T08:00:01-04:00 (2805 bytes)
...
- **Último log:** 2026-06-17T08:05:01-04:00 (9604 bytes)
...
- **Último log:** 2026-06-17T08:07:02-04:00 (292 bytes)
...
- **Último log:** 2026-06-17T03:41:01-04:00 (170 bytes)
