...
Gerado em: `2026-05-17T08:10:01-04:00`  
...
------------ | ------------------------------ | -------------- | --------------------------------------- | ----- | ------------------------------------------------------------------------------------------------
*/5 * * * *  | sync-souls.sh                  | Zeus/Infra     | baixo                                   | sim   | 2026-05-17T08:10:01-04:00 synced zeus skills/ops
*/15 * * * * | monitor-auto-push.sh           | Zeus/Infra     | baixo                                   | sim   | [2026-05-17T08:00:02-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=ae5bc77
0 10 * * *   | monitor-yoast-health-eggbev.sh | Atena/Conteúdo | baixo                                   | sim   | (sem log útil ainda)
*/15 * * * * | check-pending-reports.sh       | Zeus/Infra     | baixo                                   | sim   | [2026-05-17 08:00:01] check-pending-reports.sh concluído
*/5 * * * *  | monitor-service-restarts.sh    | Zeus/Infra     | baixo                                   | sim   | 2026-05-17T08:05:02-04:00 [monitor-service-restarts] OK
...
*/15 * * * * | track-article-cost.sh          | Atena/Conteúdo | baixo/médio: escreve SQLite local       | sim   | [2026-05-17T08:00:01-0400] Nothing to process. Exit.
...
*/15 * * * * | sync-codex-oauth.sh            | Zeus/Infra     | médio: atualiza auth.json dos profiles  | sim   | [2026-05-17T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *   | cron-control-plane.py          | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md       | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=17 generated_at=2026-05-16T16:16:42-04:00
*/15 * * * * | monitor-cron-stale-logs.sh     | Zeus/Infra     | baixo: read-only + alerta Discord       | sim   | [2026-05-17T12:00:01Z] cron-stale check: jobs=17 problems=0 resolved=0 alerts_sent=0
```
...
- **Último log:** 2026-05-17T08:10:01-04:00 (15420 bytes)
...
- **Último log:** 2026-05-17T08:00:02-04:00 (6129 bytes)
...
- **Último log:** 2026-05-17T08:00:02-04:00 (4571 bytes)
...
- **Último log:** 2026-05-17T08:05:02-04:00 (33659 bytes)
...
- **Último log:** 2026-05-17T08:05:02-04:00 (3298 bytes)
...
- **Último log:** 2026-05-17T08:00:01-04:00 (6038 bytes)
...
- **Último log:** 2026-05-17T08:00:01-04:00 (688 bytes)
...
- **Último log:** 2026-05-17T08:00:01-04:00 (12320 bytes)
...
- **Último log:** 2026-05-16T16:16:42-04:00 (430 bytes)
...
- **Último log:** 2026-05-17T08:00:01-04:00 (10455 bytes)
