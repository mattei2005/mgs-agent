...
Gerado em: `2026-07-15T08:10:01-04:00`
...
------------------- | ------------------------------------------ | ----------------- | ------------------------------------------------------------------------------------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                      | sim   | 2026-07-15T08:10:01-04:00 synced zeus skills/ops
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                      | sim   | [2026-07-15T07:56:34-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=1fac173e
...
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                      | sim   | [2026-07-15 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                      | sim   | 2026-07-15T08:06:01-04:00 [monitor-service-restarts] OK
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                      | sim   | [2026-07-14T20:37:01-04:00] OK notified upstream=bb5fc723b local=2ccfdb2db behind=105 days=1 feat=12 fix=61 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                          | sim   | [2026-07-15T08:00:02-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                       | sim   | [2026-07-15T08:00:02-0400] OK total closed zombie sessions: 0 (grace=180min)
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra        | médio: atualiza auth.json dos profiles                                                     | sim   | [2026-07-15T12:00:02Z] done: all profiles in sync, nothing to do
...
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                          | sim   | [2026-07-15T12:00:02Z] cron-stale check: jobs=33 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                          | sim   | 2026-07-15T12:05:02.437445Z done posted=0 skipped=0 candidates=0 last_seen_id=1526750273987416114
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                | sim   | [2026-07-15T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * * | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                           | sim   | [2026-07-14T22:54:33-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/15 * * * *        | discord-archive-stale-agent-threads.py     | Zeus/Infra        | não classificado                                                                           | não   | {"summary": {"mode": "apply", "profiles": ["zeus", "atena", "ares"], "checked": 17, "stale": 0, "archived": 0, "skipped_recent": 17, "errors": 0}}
*/5 * * * *         | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                       | sim   | [2026-07-15T08:05:04-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *       | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                           | sim   | (sem log útil ainda)
2-57/5 * * * *      | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                           | sim   | [2026-07-15T12:07:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1526789265273520179
...
* * * * *           | monitor_hermes_pending_writes.py           | Zeus/Infra        | não classificado                                                                           | sim   | {"action":"none","reason":"anti_spam","summary":"total=2 / >=24h=0 / mais antiga=20.3h / dead-letter=2 / memória>=80%=2","discord":"not_sent","dry_run":false}
* * * * *           | finalize-hermes-structural-write.py        | Zeus/Infra        | não classificado                                                                           | sim   | {"processed": 65, "results": [{"status": "already_closed", "id": "0066072b9a311acb1c47"}, {"status": "already_closed", "id": "04334cfdd2d2d15a932d"}, {"status": "blocked", "reason": "live_hash_drift", "id": "08784a430413
5 8 * * *           | dtr-sb-restricted-summary.py               | Zeus/Infra        | não classificado                                                                           | sim   | RuntimeError: Discord delivery failed: statuses=[{'status': 200, 'message_id': '1526922589082095616'}]
```
...
- **Último log:** 2026-07-15T08:10:01-04:00 (3431759 bytes)
...
- **Último log:** 2026-07-15T07:56:34-04:00 (815745 bytes)
...
- **Último log:** 2026-07-15T08:07:03-04:00 (330851 bytes)
...
- **Último log:** 2026-07-15T08:06:01-04:00 (5174460 bytes)
...
- **Último log:** 2026-07-15T08:08:01-04:00 (267682 bytes)
...
- **Último log:** 2026-07-14T20:37:01-04:00 (14046 bytes)
...
- **Último log:** 2026-07-15T08:00:02-04:00 (647231 bytes)
...
- **Último log:** 2026-07-15T08:00:02-04:00 (81191 bytes)
...
- **Último log:** 2026-07-15T08:00:02-04:00 (56502 bytes)
...
- **Último log:** 2026-07-15T08:00:02-04:00 (1620965 bytes)
...
- **Último log:** 2026-07-15T08:00:02-04:00 (223125 bytes)
...
- **Último log:** 2026-07-15T08:05:02-04:00 (927744 bytes)
...
- **Último log:** 2026-07-15T08:07:02-04:00 (23944 bytes)
...
- **Último log:** 2026-07-14T22:54:33-04:00 (582778 bytes)
...
- **Último log:** 2026-07-15T08:00:04-04:00 (212086 bytes)
...
- **Último log:** 2026-07-15T08:05:04-04:00 (296940 bytes)
...
- **Último log:** 2026-07-15T08:07:02-04:00 (384518 bytes)
...
- **Último log:** 2026-07-15T07:39:02-04:00 (10586 bytes)
...
- **Último log:** 2026-07-15T07:49:01-04:00 (18216 bytes)
...
- **Último log:** 2026-07-15T08:09:01-04:00 (408817 bytes)
...
- **Último log:** 2026-07-15T08:10:01-04:00 (6830141 bytes)
...
- **Último log:** 2026-07-15T08:05:14-04:00 (15162 bytes)
