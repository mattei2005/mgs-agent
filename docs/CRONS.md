...
Gerado em: `2026-08-08T08:10:02-04:00`
...
------------------------ | ------------------------------------------ | ----------------- | ------------------------------------------------------------------------------------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *              | sync-souls.sh                              | Zeus/Infra        | baixo                                                                                      | sim   | 2026-08-08T08:10:02-04:00 synced zeus skills/ops
11,26,41,56 * * * *      | monitor-auto-push.sh                       | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-08T07:56:56-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=c5fd081f
23 10 * * *              | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo    | baixo                                                                                      | sim   | [2026-08-07T10:23:08-04:00] monitor-yoast-health-eggbev: === Concluído (silencioso). SEO: 🟢216/🟡39/🔴0 / Read: 🟢212/🟡39/🔴39 ===
7,22,37,52 * * * *       | check-pending-reports.sh                   | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-08 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *           | monitor-service-restarts.sh                | Zeus/Infra        | baixo                                                                                      | sim   | 2026-08-08T08:06:01-04:00 [monitor-service-restarts] OK
54 11 * * *              | monitor-gpt55-oauth-cost.sh                | Zeus/Infra        | baixo                                                                                      | sim   | Monitor GPT-5.6 OAuth enviado: calls=696 sessions=14 input=3591670 output=364160 actual_usd=0.00 hypothetical_usd=32.79 config_ok=True billing_ok=False message_id=1535315090600104048
...
37 8,14,20 * * *         | monitor-hermes-updates.sh                  | Zeus/Infra        | baixo                                                                                      | sim   | [2026-08-07T20:37:01-04:00] OK no_changes upstream=ed3c39108b (last_notified=ed3c391)
*/15 * * * *             | track-article-cost.sh                      | Atena/Conteúdo    | baixo/médio: escreve SQLite local                                                          | sim   | [2026-08-08T08:00:01-0400] Nothing to process. Exit.
0 * * * *                | cleanup-zombie-sessions.sh                 | Zeus/Infra        | médio: fecha sessões Hermes inativas                                                       | sim   | [2026-08-08T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
...
10 8 * * *               | cron-control-plane.py                      | Zeus/Ops          | baixo: re-renderiza docs/CRONS.md                                                          | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=41 generated_at=2026-08-07T08:10:01-04:00
*/15 * * * *             | monitor-cron-stale-logs.sh                 | Zeus/Infra        | baixo: read-only + alerta Discord                                                          | sim   | [2026-08-08T12:00:02Z] cron-stale check: jobs=41 problems=0 resolved=0 alerts_sent=0
*/5 * * * *              | hermes-news-explainer.py                   | Zeus/Infra        | baixo/médio: consulta Discord e pode postar explicação automática                          | sim   | 2026-08-08T12:05:02.534900Z done posted=0 skipped=0 candidates=0 last_seen_id=1535338239496429679
7 8,14,20 * * *          | monitor-webshare-status.sh                 | Zeus/Infra        | baixo: consulta status público + alerta Discord se anomalia                                | sim   | [2026-08-08T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
...
54 8,13,18,22 * * *      | monitor-honcho-health.sh                   | Zeus/Infra        | não classificado                                                                           | sim   | [2026-08-07T22:54:38-04:00] monitor-honcho-health: DONE status=ok failures=0
...
*/5 * * * *              | monitor-vps-health.py                      | Zeus/Infra        | baixo: read-only + alerta Discord em anomalia da VPS                                       | sim   | [2026-08-08T08:05:04-0400] monitor-vps-health: DONE status=ok issues=0 resolved=0
30 7,15 * * *            | dtr-sb-page-health-sync.sh                 | Zeus/Infra        | não classificado                                                                           | sim   | (sem log útil ainda)
2-57/5 * * * *           | alerts-infra-failed-alert-resolver.py      | Zeus/Infra        | não classificado                                                                           | sim   | [2026-08-08T12:07:02Z] alerts-infra-failed-alert-resolver: DONE candidates=0 handled=0 skipped=0 last_seen_id=1535537568077062198
...
0 8 * * *                | sync-sb-sms-revenue-daily.sh               | Zeus/Revenue Tech | médio/alto: lê SB autenticada e escreve receita diária no WordPress com transação/readback | sim   | {"status": "SYNC_OK", "target_date": "2026-08-07", "groups": 7, "source_rows": 7, "revenue_cents": 67630, "net_revenue_cents": 60866, "investment_cents": 0, "readback": {"status": "DAILY_REVENUE_IMPORT_OK", "target_date"
...
24 0,1,7-23 * * *        | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                           | sim   | OK level=normal credits=225767 sent=310733 notification=none message_id=none
*/5 13,14 * * 5          | monitor-sms-funnel-balance.py              | Zeus/Infra        | não classificado                                                                           | sim   | OK level=normal credits=225767 sent=310733 notification=none message_id=none
...
* * * * *                | hermes-news-explainer-watchdog.py          | Zeus/Infra        | baixo/médio: consulta Discord a cada minuto e só posta ao recuperar explicação órfã        | sim   | 2026-08-08T12:09:01.425052Z watchdog done dry_run=0 healthy=50 waiting=0 orphan=0 recovered=0 fallback=0 failed=0 busy=0 reconciled=0 sla_seconds=600
47 4 * * *               | hermes-context-cost-audit.py               | Zeus/Infra        | baixo: leitura local + escrita atômica de estado agregado sem conteúdo das conversas       | sim   | 2026-08-08T08:47:01.835497+00:00 status=ok profiles=3 errors=0 max_context_percent=54.43 state=/root/mgs-agent/data/hermes-context-cost-audit-state.json
0 8 * * *                | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-08T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "69c6900c-0edc-35dc-0a54-b980b01953db", "template": "Infinitynexx - MX-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "MX-
*/15 * * * *             | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-08T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "69c6900c-0edc-35dc-0a54-b980b01953db", "template": "Infinitynexx - MX-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "MX-
10 23 * * *              | sb-broadcast-template-repair.sh            | Zeus/Infra        | não classificado                                                                           | não   | {"at_sp": "2026-08-08T09:00:03-03:00", "mode": "apply", "stage": "full", "templates": [{"template_id": "69c6900c-0edc-35dc-0a54-b980b01953db", "template": "Infinitynexx - MX-CC-ES/ES-ZW-SR - g004-d Joe", "vertical": "MX-
```
...
- **Último log:** 2026-08-08T08:10:02-04:00 (5823209 bytes)
...
- **Último log:** 2026-08-08T07:56:56-04:00 (1367371 bytes)
...
- **Último log:** 2026-08-07T10:23:08-04:00 (52255 bytes)
...
- **Último log:** 2026-08-08T08:07:03-04:00 (631817 bytes)
...
- **Último log:** 2026-08-08T08:06:01-04:00 (8881980 bytes)
...
- **Último log:** 2026-08-07T11:54:02-04:00 (6548 bytes)
...
- **Último log:** 2026-08-08T08:08:01-04:00 (502656 bytes)
...
- **Último log:** 2026-08-08T05:00:11-04:00 (21574 bytes)
...
- **Último log:** 2026-08-07T20:37:01-04:00 (28939 bytes)
...
- **Último log:** 2026-08-08T08:00:01-04:00 (1211711 bytes)
...
- **Último log:** 2026-08-08T08:00:01-04:00 (68599 bytes)
...
- **Último log:** 2026-08-08T08:00:01-04:00 (7852 bytes)
...
- **Último log:** 2026-08-08T08:00:01-04:00 (106038 bytes)
...
- **Último log:** 2026-08-07T08:10:01-04:00 (1978 bytes)
...
- **Último log:** 2026-08-08T08:00:02-04:00 (418965 bytes)
...
- **Último log:** 2026-08-08T08:05:02-04:00 (2112956 bytes)
...
- **Último log:** 2026-08-08T08:07:02-04:00 (44968 bytes)
...
- **Último log:** 2026-08-08T03:41:01-04:00 (13517 bytes)
...
- **Último log:** 2026-08-07T22:54:38-04:00 (610216 bytes)
...
- **Último log:** 2026-08-07T09:16:02-04:00 (4453 bytes)
...
- **Último log:** 2026-08-08T08:00:04-04:00 (548759 bytes)
...
- **Último log:** 2026-08-08T08:05:04-04:00 (869713 bytes)
...
- **Último log:** 2026-08-08T08:07:02-04:00 (1283738 bytes)
...
- **Último log:** 2026-08-08T06:56:31-04:00 (172898 bytes)
...
- **Último log:** 2026-08-08T07:39:02-04:00 (67125 bytes)
...
- **Último log:** 2026-08-08T07:49:02-04:00 (158949 bytes)
...
- **Último log:** 2026-08-08T08:00:15-04:00 (19383 bytes)
...
- **Último log:** 2026-08-08T08:09:01-04:00 (6740993 bytes)
...
- **Último log:** 2026-08-08T08:10:02-04:00 (959604 bytes)
...
- **Último log:** 2026-08-08T08:05:16-04:00 (145138 bytes)
...
- **Último log:** 2026-08-08T07:59:17-04:00 (7622330 bytes)
...
- **Último log:** 2026-08-08T07:24:03-04:00 (39204 bytes)
...
- **Último log:** 2026-08-08T08:04:01-04:00 (585528 bytes)
...
- **Último log:** 2026-08-08T08:09:01-04:00 (5207183 bytes)
...
- **Último log:** 2026-08-08T04:47:10-04:00 (2473 bytes)
...
- **Último log:** 2026-08-08T08:01:22-04:00 (66840 bytes)
