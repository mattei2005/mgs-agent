...
Gerado em: `2026-06-30T08:10:01-04:00`
...
------------------- | ------------------------------------------ | -------------- | ----------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/5 * * * *         | sync-souls.sh                              | Zeus/Infra     | baixo                                                             | sim   | 2026-06-30T08:05:02-04:00 synced hera skills/creative/meta-library-reference-intake
11,26,41,56 * * * * | monitor-auto-push.sh                       | Zeus/Infra     | baixo                                                             | sim   | [2026-06-30T07:56:04-04:00] monitor-auto-push: Concluído. consecutive_failures=0 last_ok=5de4a818
23 10 * * *         | monitor-yoast-health-eggbev.sh             | Atena/Conteúdo | baixo                                                             | sim   | [2026-06-29T10:23:02-04:00] monitor-yoast-health-eggbev: Credenciais OK.
7,22,37,52 * * * *  | check-pending-reports.sh                   | Zeus/Infra     | baixo                                                             | sim   | [2026-06-30 08:07:01] check-pending-reports.sh concluído
1-56/5 * * * *      | monitor-service-restarts.sh                | Zeus/Infra     | baixo                                                             | sim   | 2026-06-30T08:06:01-04:00 [monitor-service-restarts] OK
47 12 * * *         | monitor-gpt55-oauth-cost.sh                | Zeus/Infra     | baixo                                                             | sim   | Zeus 358 Atena 134 Ares 1 Hera 2
...
37 8,14,20 * * *    | monitor-hermes-updates.sh                  | Zeus/Infra     | baixo                                                             | sim   | [2026-06-29T20:37:02-04:00] OK notified upstream=f3d2dfbec local=0f81b0d45 behind=560 days=3 feat=68 fix=331 breaking=0
*/15 * * * *        | track-article-cost.sh                      | Atena/Conteúdo | baixo/médio: escreve SQLite local                                 | sim   | [2026-06-30T08:00:01-0400] Nothing to process. Exit.
0 * * * *           | cleanup-zombie-sessions.sh                 | Zeus/Infra     | médio: fecha sessões Hermes inativas                              | sim   | [2026-06-30T08:00:01-0400] OK total closed zombie sessions: 0 (grace=180min)
17 3 * * *          | housekeeping-bak-cleanup.sh                | Zeus/Infra     | alto: deleta backups antigos, preservando último por família      | sim   | [2026-06-30T03:17:02-04:00] housekeeping:   rm /root/.hermes/profiles/hera/auth.json.bak.20260614T230855-0400
...
*/15 * * * *        | sync-codex-oauth.sh                        | Zeus/Infra     | médio: atualiza auth.json dos profiles                            | sim   | [2026-06-30T12:00:01Z] done: all profiles in sync, nothing to do
10 8 * * *          | cron-control-plane.py                      | Zeus/Ops       | baixo: re-renderiza docs/CRONS.md                                 | sim   | OK wrote /root/mgs-agent/docs/CRONS.md jobs=22 generated_at=2026-06-29T08:10:01-04:00
*/15 * * * *        | monitor-cron-stale-logs.sh                 | Zeus/Infra     | baixo: read-only + alerta Discord                                 | sim   | [2026-06-30T12:00:01Z] cron-stale check: jobs=22 problems=0 resolved=0 alerts_sent=0
*/5 * * * *         | hermes-news-explainer.py                   | Zeus/Infra     | baixo/médio: consulta Discord e pode postar explicação automática | sim   | 2026-06-30T12:05:02.191307Z done posted=0 skipped=0 candidates=0 last_seen_id=1521314411837657098
7 8,14,20 * * *     | monitor-webshare-status.sh                 | Zeus/Infra     | baixo: consulta status público + alerta Discord se anomalia       | sim   | [2026-06-30T08:07:02-04:00] monitor-webshare-status: OK completed mode=normal
41 3 * * *          | mgs-safety-backup.sh                       | Zeus/Infra     | médio: cria tar.gz local, exclui segredos por padrão              | sim   | [2026-06-30T03:41:01-04:00] mgs-safety-backup: SKIP: último backup ainda dentro do intervalo de 3 dias: /root/mgs-agent/backups/safety/mgs-safety-20260628-034101.tar.gz
*/15 * * * *        | monitor-honcho-health.sh                   | Zeus/Infra     | não classificado                                                  | sim   | [2026-06-30T08:00:49-04:00] monitor-honcho-health: DONE status=ok failures=0
16 9 * * *          | monitor-discord-thread-archive-warnings.py | Zeus/Infra     | baixo: consulta Discord + alerta Rodolfo antes de auto-archive    | sim   | monitor-discord-thread-archive-warnings: OK candidates=0 pending_alerts=0 posted=False errors=0
```
...
- **Último log:** 2026-06-30T08:05:02-04:00 (1293569 bytes)
...
- **Último log:** 2026-06-30T07:56:04-04:00 (429520 bytes)
...
- **Último log:** 2026-06-29T10:23:02-04:00 (6539 bytes)
...
- **Último log:** 2026-06-30T08:07:02-04:00 (149286 bytes)
...
- **Último log:** 2026-06-30T08:06:01-04:00 (2327798 bytes)
...
- **Último log:** 2026-06-29T12:47:03-04:00 (1104 bytes)
...
- **Último log:** 2026-06-30T08:08:01-04:00 (120836 bytes)
...
- **Último log:** 2026-06-30T05:00:09-04:00 (8848 bytes)
...
- **Último log:** 2026-06-29T20:37:02-04:00 (6350 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (290325 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (62336 bytes)

### `housekeeping-bak-cleanup.sh`
- **Frequência:** `17 3 * * *`
- **Owner:** Zeus/Infra
- **Risco:** alto: deleta backups antigos, preservando último por família
- **Função:** Remove backups antigos (.bak/.backup/.old/.orig/~) com retenção padrão de 15 dias, preservando sempre o último por família; também aplica retenção dedicada para `hermes-profiles-backup-*.tar.gz` de updates Hermes (mantém 2 mais recentes, remove antigos acima de 2 dias).
...
- **Último log:** 2026-06-30T03:17:02-04:00 (9379 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (1963 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (25542 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (692165 bytes)
...
- **Último log:** 2026-06-29T08:10:01-04:00 (1290 bytes)
...
- **Último log:** 2026-06-30T08:00:01-04:00 (100725 bytes)
...
- **Último log:** 2026-06-30T08:05:02-04:00 (348292 bytes)
...
- **Último log:** 2026-06-30T08:07:02-04:00 (10804 bytes)
...
- **Último log:** 2026-06-30T03:41:01-04:00 (2315 bytes)
...
- **Último log:** 2026-06-30T08:00:49-04:00 (277845 bytes)
...
- **Último log:** 2026-06-29T09:16:02-04:00 (217 bytes)
