...
def build_report() -> str:
    ...
    lines = [
        ...
        "- Estado real: intake, validação do briefing e preparação do resumo são possíveis; manifest executável, dry-run v3 e write permanecem bloqueados até onboarding da conta, payload completo de placements e mídia pre-stageada.",
        "",
        "## Estrutura fixa",
        ...
        "5. Criativos novos, nomes individuais dos anúncios e linhagem Drive → Meta.",
        "6. Copy completa: `Primary text`, `Headline`, `Description` e `CTA`.",
        "7. Links, `url_tags`/UTMs e qualquer exceção de público, placement ou estratégia.",
        "",
        "## Criativos e copy",
        ...
        f"- Naming da campanha: `{op['campaign_naming']['pattern']}`.",
        f"- Nome de cada anúncio: {op['campaign_naming']['ad_name']}.",
        ...
        "- USD 45 não é default de criação normal; é uma exceção exclusiva de `clone_page_switch`.",
        ...
        "7. Executar validate/plan/dry-run quando o onboarding v3 estiver concluído.",
