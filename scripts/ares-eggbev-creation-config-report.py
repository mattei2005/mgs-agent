...
def build_report() -> str:
    ...
    lines = [
        ...
        "- Toda campanha nova carrega esse arquivo em cada creative; arquivo ausente/inválido/divergente bloqueia antes do write. Após a criação, cada creative Meta é comparado diretamente com o arquivo antes de concluir o pós-processamento.",
