#!/usr/bin/env python3
"""Probe/analyze YouTube references with Hera's persistent Chromium profile.

This is Plan A for Hera YouTube references: keep a stable Chromium user-data-dir
...
DEFAULT_PROFILE = Path("/root/.hermes/profiles/hera/browser-profiles/youtube-chromium")
DEFAULT_OUT = Path("/root/mgs-agent/data/references/hera/youtube-persistent")
