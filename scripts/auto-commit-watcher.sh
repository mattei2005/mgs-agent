...
SENSITIVE_ALLOWLIST_REGEX='(^|/)(honcho_sanitized_secret_scan\.py|report-infra-runtime-permissions-auth-and-secret-wrappers-2026-06-17\.md|service-account-token-rotation-bootstrap\.md|profiles/zeus-skills/growth/meta-app-rate-limit-monitor/references/discord-webhook-alert-format\.md|profiles/ares-skills/growth/meta-ads-governance-guardrails/references/meta-eu-finserv-ad-token-scopes\.md|profiles/zeus-skills/growth/meta-ads-api-operations/references/multi-account-token-cutover-page-parity-2026-09-02\.md|data/sb-messenger-token-invalid-monitor\.json|profiles/zeus-skills/ops/log-monitor-discord-alert/references/sb-messenger-token-invalid-monitor\.md|scripts/monitor-sb-messenger-token-invalid\.py|tests/fixtures/sb-messenger-token-invalid\.json|tests/test_monitor_sb_messenger_token_invalid\.py|tests/test_creditoparaveiculo_account13_token_routing\.py|profiles/zeus-skills/growth/meta-ads-api-operations/references/meta-business-1password-totp-reauth-2026-09-08\.md|data/ares/meta-ads/research/SHEIN-US-DIRECT-rate-limit-token-architecture-20260912\.json|profiles/ares-skills/growth/paid-acquisition-operations/references/meta-business-login-user-token-setup\.md|work/ares-shein-onboarding-20260911/developer-accounts-token-answer\.md|profiles/ares-skills/growth/paid-acquisition-operations/references/meta-facebook-login-for-business-token-selection\.md|profiles/ares-skills/growth/paid-acquisition-operations/references/meta-credential-cutover-and-retirement\.md)$'
