...
STATUS_FILE="/root/.hermes/profiles/ares/artifacts/meta-library-login-status.json"
BACKUP_ROOT="/root/.hermes/profiles/ares/browser-profile-backups/meta-library-chromium"
...
REPORT_ROOT="/root/.hermes/profiles/ares/artifacts/meta-library"
