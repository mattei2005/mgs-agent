...
def build_report() -> str:
    ...
    lines = [
        ...
        f"- Saída visível: quatro blocos compactos mobile-first + no máximo {anomaly['maximum_visible_bullets']} bullets curtos abaixo.",
        "",
        "## Runtime atual",
        ...
        f"- Campos sem entrega: {', '.join(renderer['no_delivery_fields'])}.",
