...
log "Pre services"
systemctl is-active zeus-gateway.service atena-gateway.service ares-gateway.service hera-gateway.service || true
log "Restarting gateways: atena ares hera zeus"
systemctl restart atena-gateway.service ares-gateway.service hera-gateway.service
