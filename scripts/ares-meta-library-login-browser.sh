...
DISPLAY_NUM="${ARES_META_DISPLAY:-95}"
DISPLAY_ADDR=":${DISPLAY_NUM}"
VNC_PORT="${ARES_META_VNC_PORT:-5903}"
NOVNC_PORT="${ARES_META_NOVNC_PORT:-6083}"
PROFILE_DIR="${ARES_META_LIBRARY_PROFILE:-/root/.hermes/profiles/ares/browser-profiles/meta-library-chromium}"
LOCK_FILE="/root/.hermes/profiles/ares/browser-profiles/.meta-library-collector.lock"
LOG_DIR="/root/.hermes/profiles/ares/logs"
...
export ARES_META_LIBRARY_PROFILE="$PROFILE_DIR"
