...
async function main() {
  ...
  const profileDir = process.env.HERA_META_LIBRARY_PROFILE || '/root/.hermes/profiles/hera/browser-profiles/meta-library-chromium';
  const statusPath = process.env.HERA_META_LIBRARY_LOGIN_STATUS || '/root/.hermes/profiles/hera/artifacts/meta-library-login-status.json';
