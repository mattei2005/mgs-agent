...
const CONFIG_PATH = process.env.HERA_META_LIBRARY_PROXY_CONFIG || '/root/mgs-agent/data/hera-meta-library-proxy.json';
...
function resolveProxyConfig() {
  const explicitServer = process.env.HERA_META_LIBRARY_PROXY || '';
  const explicitMode = process.env.HERA_META_LIBRARY_PROXY_MODE || '';
