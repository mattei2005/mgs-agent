...
OPERATION = 'CAR_BR_BR'
THREAD_ID = '1545812108296454164'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260905T150650Z-kelly-car-br-br-thread-1545812108296454164')
...
# Current batch classification from 15 real multi-frame timelines.
CLASSIFICATION = {
    '1_258 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; PARCELAS DE R$ 299; R$ 299/MÊS; SEM ENTRADA',
    },
    '2_53 BR_CAR__BR_ MOTO 03-09 - IA - Story (BRASIL)) .mp4': {
        'vehicle_type': 'MOTO', 'angle': 'SEM_ENTRADA', 'person': 'PERSON',
        'claim': 'PARCELAS DE R$ 149 MENSAIS; SEM ENTRADA',
    },
    '3_263 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; PARCELAS DE R$ 299; SEM ENTRADA; R$ 299/MÊS',
    },
    '4_257 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; PARCELAS DE R$ 299; R$ 299/MÊS; SEM ENTRADA',
    },
    '5_261 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'SEM ENTRADA; APROVA NEGATIVADO; PARCELAS DE R$ 299',
    },
    '6_262 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; PARCELAS DE R$ 299; SEM ENTRADA',
    },
    '7_265 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; PARCELAS DE R$ 299 POR MÊS',
    },
    '8_266 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; PARCELAS DE R$ 299 POR MÊS',
    },
    '9_256 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; PARCELAS DE R$ 299; R$ 299/MÊS',
    },
    '10_260 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; PARCELAS DE R$ 299',
    },
    '11_267 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; R$ 299/MÊS; PARCELAS DE R$ 299',
    },
    '12_264 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; SEM ENTRADA; PARCELAS DE R$ 299; R$ 299/MÊS',
    },
    '13_259 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; R$ 100 DE ENTRADA; PARCELAS DE R$ 299',
    },
    '14_268 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; R$ 100 DE ENTRADA; PARCELAS DE R$ 299',
    },
    '15_255 BR_CAR__BR_05-09 - IA - Story (BRASIL).mp4': {
        'vehicle_type': 'CARRO', 'angle': 'SCORE_BAIXO', 'person': 'PERSON',
        'claim': 'APROVA NEGATIVADO; PARCELAS DE R$ 299; R$ 299/MÊS; SEM ENTRADA',
    },
}
...
def main() -> int:
    ...
    if len(input_rows) != 15:
        raise RuntimeError(f'expected 15 videos, found {len(input_rows)}')
