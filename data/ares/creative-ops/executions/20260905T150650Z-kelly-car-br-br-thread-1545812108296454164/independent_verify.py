...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260905T150650Z-kelly-car-br-br-thread-1545812108296454164')
...
for idx, row in enumerate(rows, 1):
    ...
    if row['disposition'] == 'UNIQUE_READY':
        ...
        inv_ok = bool(inv and inv.get('asset_drive_id') == did and inv.get('canonical_filename') == row['destination_filename'] and inv.get('metadata_clean') is True and inv.get('reservation_status') == 'RESERVADO_PELO_GESTOR' and inv.get('ares_eligible') is False and inv.get('thread_id') == '1545812108296454164')
    else:
