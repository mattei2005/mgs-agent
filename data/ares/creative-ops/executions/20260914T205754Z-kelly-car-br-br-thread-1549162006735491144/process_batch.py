...
OPERATION = 'CAR_BR_BR'
THREAD_ID = '1549162006735491144'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260914T205754Z-kelly-car-br-br-thread-1549162006735491144')
...
def main() -> int:
    ...
    if len(input_rows) != 20:
        raise RuntimeError(f'expected 20 scoped BR-CAR videos, found {len(input_rows)}')
