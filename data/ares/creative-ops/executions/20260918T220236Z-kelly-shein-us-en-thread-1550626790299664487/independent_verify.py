...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260918T220236Z-kelly-shein-us-en-thread-1550626790299664487')
...
if len(rows) != 24 or len(set(source_ids)) != 24 or len(set(dest_ids)) != 24:
