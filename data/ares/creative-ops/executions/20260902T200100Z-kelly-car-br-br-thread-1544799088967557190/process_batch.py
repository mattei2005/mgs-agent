...
OPERATION = 'CAR_BR_BR'
THREAD_ID = '1544799088967557190'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260902T200100Z-kelly-car-br-br-thread-1544799088967557190')
...
def main() -> int:
    ...
    if len(input_rows) != 21:
        raise RuntimeError(f'expected 21 videos, found {len(input_rows)}')
