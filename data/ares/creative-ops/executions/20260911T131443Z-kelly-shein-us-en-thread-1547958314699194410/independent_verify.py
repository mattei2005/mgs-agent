...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260911T131443Z-kelly-shein-us-en-thread-1547958314699194410')
...
if len(rows) != 33 or len(set(source_ids)) != 33 or len(set(dest_ids)) != 33:
