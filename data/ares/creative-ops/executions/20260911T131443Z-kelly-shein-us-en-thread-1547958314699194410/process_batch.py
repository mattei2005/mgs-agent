...
THREAD_ID = '1547958314699194410'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260911T131443Z-kelly-shein-us-en-thread-1547958314699194410')
...
def main() -> int:
    ...
    if len(input_rows) != 33:
        raise RuntimeError(f'expected 33 videos, found {len(input_rows)}')
