...
THREAD_ID = '1545439313246818334'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260904T142558Z-kelly-shein-us-en-thread-1545439313246818334')
...
def main() -> int:
    ...
    if len(input_rows) != 25:
        raise RuntimeError(f'expected 25 videos, found {len(input_rows)}')
