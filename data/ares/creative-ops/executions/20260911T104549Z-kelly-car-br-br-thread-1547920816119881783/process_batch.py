...
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260911T104549Z-kelly-car-br-br-thread-1547920816119881783')
...
def main() -> int:
    ...
    if len(input_rows) != 32:
        raise RuntimeError(f'expected 32 scoped BR-CAR videos, found {len(input_rows)}')
