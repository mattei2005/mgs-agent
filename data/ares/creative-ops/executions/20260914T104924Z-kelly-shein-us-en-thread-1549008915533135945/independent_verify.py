...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260914T104924Z-kelly-shein-us-en-thread-1549008915533135945')
...
if len(rows) != 38 or len(set(source_ids)) != 38 or len(set(dest_ids)) != 38:
