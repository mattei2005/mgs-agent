...
THREAD_ID = '1549008915533135945'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260914T104924Z-kelly-shein-us-en-thread-1549008915533135945')
...
def main() -> int:
    ...
    if len(input_rows) != 38:
        raise RuntimeError(f'expected 38 videos, found {len(input_rows)}')
