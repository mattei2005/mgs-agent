...
THREAD_ID = '1545536009595261079'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260904T204908Z-kelly-shein-us-en-thread-1545536009595261079')
...
def main() -> int:
    ...
    if len(input_rows) != 32:
        raise RuntimeError(f'expected 32 videos, found {len(input_rows)}')
