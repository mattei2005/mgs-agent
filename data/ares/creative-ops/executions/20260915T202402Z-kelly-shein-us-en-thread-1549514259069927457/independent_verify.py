...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260915T202402Z-kelly-shein-us-en-thread-1549514259069927457')
...
if len(rows) != 29 or len(set(source_ids)) != 29 or len(set(dest_ids)) != 29:
