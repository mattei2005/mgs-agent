...
THREAD_ID = '1549514259069927457'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260915T202402Z-kelly-shein-us-en-thread-1549514259069927457')
...
def main() -> int:
    ...
    if len(input_rows) != 29:
        raise RuntimeError(f'expected 29 videos, found {len(input_rows)}')
