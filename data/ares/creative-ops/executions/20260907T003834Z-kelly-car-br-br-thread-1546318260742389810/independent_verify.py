...
BASE = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260907T003834Z-kelly-car-br-br-thread-1546318260742389810')
...
for idx, row in enumerate(rows, 1):
    ...
    if row['disposition'] == 'UNIQUE_READY':
        ...
        inv_ok = bool(inv and inv.get('asset_drive_id') == did and inv.get('canonical_filename') == row['destination_filename'] and inv.get('metadata_clean') is True and inv.get('reservation_status') == 'RESERVADO_PELO_GESTOR' and inv.get('ares_eligible') is False and inv.get('thread_id') == '1546318260742389810')
    else:
