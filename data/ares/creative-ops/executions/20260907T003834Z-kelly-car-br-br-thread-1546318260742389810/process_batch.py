...
OPERATION = 'CAR_BR_BR'
THREAD_ID = '1546318260742389810'
INVENTORY = Path('/root/mgs-agent/data/ares/creative-ops/inventory/assets.jsonl')
REPORT_DIR = Path('/root/mgs-agent/data/ares/creative-ops/executions/20260907T003834Z-kelly-car-br-br-thread-1546318260742389810')
...
def main() -> int:
    ...
    if len(input_rows) != 34:
        raise RuntimeError(f'expected 34 videos, found {len(input_rows)}')
