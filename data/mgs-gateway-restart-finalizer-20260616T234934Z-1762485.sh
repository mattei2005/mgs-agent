#!/usr/bin/env bash
set -euo pipefail
LOG="/root/mgs-agent/logs/mgs-gateway-restart-finalizer-20260616T234934Z-1762485.log"
AUDIT="/root/mgs-agent/logs/events-audit.jsonl"
REASON="Carregar regra Ares: handoff para Hera deve usar user mention real do bot Hera, não texto literal @Hera"
exec >>"$LOG" 2>&1
