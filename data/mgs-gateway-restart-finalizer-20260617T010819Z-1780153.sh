#!/usr/bin/env bash
set -euo pipefail
LOG="/root/mgs-agent/logs/mgs-gateway-restart-finalizer-20260617T010819Z-1780153.log"
AUDIT="/root/mgs-agent/logs/events-audit.jsonl"
REASON="Rodolfo approved full gateway restart after Grok OAuth rollout"
exec >>"$LOG" 2>&1
