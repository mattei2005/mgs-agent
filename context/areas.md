...
Estratégia, prioridades, reuniões diárias, decisões finais, criação/remoção de áreas e agentes, aprovação de mudanças críticas.
...
Regra atual: Smart Bidding é a central principal. ActiveView é exceção ativa para `openzed`, `cliquet` e respectivos subdomínios.
...
WordPress técnico, home, categorias, plugins, pixels, VPS, Hermes, bots, crons, scripts, patches e monitoramento.
