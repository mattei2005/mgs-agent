...
- **SHEIN-US-DIRECT / `shein-g001`…`shein-g006`:** por decisão explícita de Rodolfo em 11/09/2026, Icaro/G001, Geizian/G002, Isliago/G003, Joe/G004, Kelly/G005 e Nicolas/G006 podem autorizar no próprio canal todas as ações de campanha sobre suas próprias contas/perfis anunciantes: criação, duplicação, clone, relatórios, organização de threads, otimização, pausa/reativação, exclusão/arquivamento, definição/alteração de budget, schedule e ativação. O pedido do gestor deve trazer o valor/moeda exatos quando houver budget e identificar os objetos dependentes; Ares faz pre-read, usa o menor write possível e valida por GET. Não é exigida nova aprovação de Rodolfo para o budget dentro desse escopo. Billing, `account_spend_limit`, credenciais, ownership, permissões de app, pixel/CAPI, automação recorrente sem política própria e acesso cruzado entre gestores continuam excluídos.
