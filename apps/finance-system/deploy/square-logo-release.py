"""Static-only square-logo correction. No auth, database or service changes."""
...
FILES=['public/mgs-logo.png','public/login.css','public/navigation.css','public/refinements.css','public/login.html','public/navigation.js'];local={f:hashlib.sha256((ROOT/f).read_bytes()).hexdigest() for f in FILES}
...
if phase=='prepare':
 ...
 save('square-published.json',{'pass':True,'files':local,'financial_data_unchanged':True,'restart':False});print('Square logo static publication/readback PASS; no restart or financial write')
elif phase=='verify':
