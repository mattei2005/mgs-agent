...
if phase=='prepare':
 ...
 with tarfile.open(fileobj=payload,mode='w:gz') as t:
  ...
  for f in ['finance-ops-schema.sql','deploy/meta-lookup-queue.py','deploy/finance-notices.mjs','tests/payments-pg.mjs']:t.add(ROOT/f,arcname=f)
