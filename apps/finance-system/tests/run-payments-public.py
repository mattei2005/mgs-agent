...
password=secret('MGS Finance - rodolfo - dash.mgsdigitalcorp.com','password');r=subprocess.run(['node','tests/payments-browser.mjs'],input=json.dumps({'username':'rodolfo','password':password}),text=True,capture_output=True,cwd=ROOT,timeout=420)
print(r.stdout)
