...
test('login UI uses staged password, authenticator and recovery views',async()=>{
 ...
 for(const marker of ['mfaPanel','mfaQr','setupKey','recoveryPanel','recoveryCodes'])assert.match(html,new RegExp(`id="${marker}"`));
