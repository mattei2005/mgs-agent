"""Fresh closed-history capture for authorized import1546884731436671056; Google GET only."""
import sys,pathlib,json,datetime,re,time,hashlib,unicodedata,urllib.parse
R=pathlib.Path(__file__).resolve().parents[1];D=R/'private/history-import-1546884731436671056';D.mkdir(mode=0o700,parents=True,exist_ok=True)
