...
test('edited expenses do not show the removed adjustment caption',()=>{assert.ok(!src.includes('Valor ajustado na dash'));assert.ok(src.includes('Remuneração automática · fórmula do gestor'));assert.ok(src.includes('Despesa extra'));});
