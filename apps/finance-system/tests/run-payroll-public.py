"""Read-only authenticated public payroll browser acceptance."""
...
r=subprocess.run(['node','tests/payroll-browser.mjs'],input=json.dumps({'username':'rodolfo','password':password}),text=True,capture_output=True,cwd=ROOT,env={**os.environ,'FINANCE_PUBLIC':'1'},timeout=240)
print(r.stdout)
